 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 51b:	0f 84 ff 00 00 00    	je     620 <printf+0x170>
 ...
 5b4:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5b7:	e8 a7 fd ff ff       	call   363 <write>
        ap++;
 5bc:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
 5c0:	83 c4 10             	add    $0x10,%esp
      state = 0;
 5c3:	31 c9                	xor    %ecx,%ecx
 5c5:	e9 38 ff ff ff       	jmp    502 <printf+0x52>
 ...
 5dd:	74 51                	je     630 <printf+0x180>
        while(*s != 0){
 5df:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
 5e2:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
 5e4:	84 c0                	test   %al,%al
 5e6:	0f 84 16 ff ff ff    	je     502 <printf+0x52>
 5ec:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 5ef:	89 d3                	mov    %edx,%ebx
 ...
 603:	57                   	push   %edi
 604:	56                   	push   %esi
 605:	e8 59 fd ff ff       	call   363 <write>
        while(*s != 0){
 ...
 612:	75 e4                	jne    5f8 <printf+0x148>
      state = 0;
 614:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
 617:	31 c9                	xor    %ecx,%ecx
 619:	e9 e4 fe ff ff       	jmp    502 <printf+0x52>
 61e:	66 90                	xchg   %ax,%ax
        putc(fd, c);
 620:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 623:	83 ec 04             	sub    $0x4,%esp
 626:	e9 32 ff ff ff       	jmp    55d <printf+0xad>
 62b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 62f:	90                   	nop
          s = "(null)";
 630:	ba 58 08 00 00       	mov    $0x858,%edx
        while(*s != 0){
 635:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 638:	b8 28 00 00 00       	mov    $0x28,%eax
 63d:	89 d3                	mov    %edx,%ebx
 63f:	eb b7                	jmp    5f8 <printf+0x148>
...
void srand(unsigned seed) {
 ...
 7e6:	5d                   	pop    %ebp
    next = seed;
 7e7:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 7ec:	c3                   	ret    
...
int rand(void) {
 ...
 7f0:	69 05 a0 0b 00 00 6d 	imul   $0x41c64e6d,0xba0,%eax
 7f7:	4e c6 41 
 7fa:	05 39 30 00 00       	add    $0x3039,%eax
 7ff:	a3 a0 0b 00 00       	mov    %eax,0xba0
    return((unsigned)(next/65536) % RAND_MAX);
 804:	c1 e8 10             	shr    $0x10,%eax
}
 807:	c3                   	ret    
