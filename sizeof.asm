...
main(int argc, char *argv[])
{
  ...
  11:	6a 20                	push   $0x20
  13:	68 f8 07 00 00       	push   $0x7f8
  18:	6a 01                	push   $0x1
  1a:	e8 81 04 00 00       	call   4a0 <printf>
    {
        unsigned int i = 1;
  ...
  2d:	59                   	pop    %ecx
  2e:	58                   	pop    %eax
  2f:	68 92 09 00 00       	push   $0x992
  34:	6a 01                	push   $0x1
  36:	e8 65 04 00 00       	call   4a0 <printf>

    printf(1, "Size of basic C data types\n");
  3b:	58                   	pop    %eax
  3c:	5a                   	pop    %edx
  3d:	68 78 09 00 00       	push   $0x978
  42:	6a 01                	push   $0x1
  44:	e8 57 04 00 00       	call   4a0 <printf>
    printf(1, "                        bytes  bits\n");
  49:	59                   	pop    %ecx
  4a:	58                   	pop    %eax
  4b:	68 44 08 00 00       	push   $0x844
  50:	6a 01                	push   $0x1
  52:	e8 49 04 00 00       	call   4a0 <printf>
    printf(1, "    sizeof(char)        %d      %d\n"
  57:	6a 08                	push   $0x8
  59:	6a 01                	push   $0x1
  5b:	68 6c 08 00 00       	push   $0x86c
  60:	6a 01                	push   $0x1
  ...
  8d:	6a 20                	push   $0x20
  8f:	6a 04                	push   $0x4
  91:	68 d8 08 00 00       	push   $0x8d8
  96:	6a 01                	push   $0x1
  98:	e8 03 04 00 00       	call   4a0 <printf>
           , (int) sizeof(unsigned)
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 f4 09 00 00 	movzbl 0x9f4(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 50b:	0f 84 ff 00 00 00    	je     610 <printf+0x170>
 511:	83 e8 63             	sub    $0x63,%eax
 514:	83 f8 15             	cmp    $0x15,%eax
 517:	77 17                	ja     530 <printf+0x90>
 519:	ff 24 85 9c 09 00 00 	jmp    *0x99c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a3:	56                   	push   %esi
        putc(fd, *ap);
 5a4:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5a7:	e8 a7 fd ff ff       	call   353 <write>
        ap++;
 5ac:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
 5b0:	83 c4 10             	add    $0x10,%esp
      state = 0;
 5b3:	31 c9                	xor    %ecx,%ecx
 5b5:	e9 38 ff ff ff       	jmp    4f2 <printf+0x52>
 ...
 5cd:	74 51                	je     620 <printf+0x180>
        while(*s != 0){
 5cf:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
 5d2:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
 5d4:	84 c0                	test   %al,%al
 5d6:	0f 84 16 ff ff ff    	je     4f2 <printf+0x52>
 5dc:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 5df:	89 d3                	mov    %edx,%ebx
 5e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
 5e8:	83 ec 04             	sub    $0x4,%esp
          s++;
 5eb:	83 c3 01             	add    $0x1,%ebx
 5ee:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5f1:	6a 01                	push   $0x1
 5f3:	57                   	push   %edi
 5f4:	56                   	push   %esi
 5f5:	e8 59 fd ff ff       	call   353 <write>
        while(*s != 0){
 5fa:	0f b6 03             	movzbl (%ebx),%eax
 5fd:	83 c4 10             	add    $0x10,%esp
 600:	84 c0                	test   %al,%al
 602:	75 e4                	jne    5e8 <printf+0x148>
      state = 0;
 604:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
 607:	31 c9                	xor    %ecx,%ecx
 609:	e9 e4 fe ff ff       	jmp    4f2 <printf+0x52>
 60e:	66 90                	xchg   %ax,%ax
        putc(fd, c);
 610:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 613:	83 ec 04             	sub    $0x4,%esp
 616:	e9 32 ff ff ff       	jmp    54d <printf+0xad>
 61b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 61f:	90                   	nop
          s = "(null)";
 620:	ba 94 09 00 00       	mov    $0x994,%edx
        while(*s != 0){
 625:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 628:	b8 28 00 00 00       	mov    $0x28,%eax
 62d:	89 d3                	mov    %edx,%ebx
 62f:	eb b7                	jmp    5e8 <printf+0x148>
...
free(void *ap)
{
 ...
 641:	a1 d4 0c 00 00       	mov    0xcd4,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 d4 0c 00 00    	mov    %edx,0xcd4
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 d4 0c 00 00    	mov    %edx,0xcd4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d d4 0c 00 00    	mov    0xcd4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d d4 0c 00 00    	mov    0xcd4,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 d4 0c 00 00    	mov    0xcd4,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 d4 0c 00 00    	mov    %edx,0xcd4
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 d4 0c 00 00 d8 	movl   $0xcd8,0xcd4
 797:	0c 00 00 
    base.s.size = 0;
 79a:	bf d8 0c 00 00       	mov    $0xcd8,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 d8 0c 00 00 d8 	movl   $0xcd8,0xcd8
 7a6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 dc 0c 00 00 00 	movl   $0x0,0xcdc
 7b2:	00 00 00 
    if(p->s.size >= nunits){
...
void srand(unsigned seed) {
 ...
 7d6:	5d                   	pop    %ebp
    next = seed;
 7d7:	a3 d0 0c 00 00       	mov    %eax,0xcd0
}
 7dc:	c3                   	ret    
...
int rand(void) {
 ...
 7e0:	69 05 d0 0c 00 00 6d 	imul   $0x41c64e6d,0xcd0,%eax
 7e7:	4e c6 41 
 7ea:	05 39 30 00 00       	add    $0x3039,%eax
 7ef:	a3 d0 0c 00 00       	mov    %eax,0xcd0
    return((unsigned)(next/65536) % RAND_MAX);
 7f4:	c1 e8 10             	shr    $0x10,%eax
}
 7f7:	c3                   	ret    
