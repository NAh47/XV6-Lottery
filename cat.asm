 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 64f:	90                   	nop
          s = "(null)";
 650:	ba 60 08 00 00       	mov    $0x860,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 e0 0d 00 00       	mov    0xde0,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 e0 0d 00 00    	mov    %edx,0xde0
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 e0 0d 00 00    	mov    %edx,0xde0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d e0 0d 00 00    	mov    0xde0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d e0 0d 00 00    	mov    0xde0,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 e0 0d 00 00    	mov    0xde0,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 e0 0d 00 00    	mov    %edx,0xde0
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 e0 0d 00 00 e4 	movl   $0xde4,0xde0
 7c7:	0d 00 00 
    base.s.size = 0;
 7ca:	bf e4 0d 00 00       	mov    $0xde4,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 e4 0d 00 00 e4 	movl   $0xde4,0xde4
 7d6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 e8 0d 00 00 00 	movl   $0x0,0xde8
 7e2:	00 00 00 
    if(p->s.size >= nunits){
...
void srand(unsigned seed) {
 ...
 806:	5d                   	pop    %ebp
    next = seed;
 807:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 80c:	c3                   	ret    
...
int rand(void) {
 ...
 810:	69 05 d8 0b 00 00 6d 	imul   $0x41c64e6d,0xbd8,%eax
 817:	4e c6 41 
 81a:	05 39 30 00 00       	add    $0x3039,%eax
 81f:	a3 d8 0b 00 00       	mov    %eax,0xbd8
