...
main(int argc, char *argv[])
{
  ...
  14:	89 c3                	mov    %eax,%ebx
    ...
    pid = fork();
  16:	e8 90 02 00 00       	call   2ab <fork>
    if (pid == 0) {
  1b:	85 c0                	test   %eax,%eax
  1d:	75 21                	jne    40 <main+0x40>
        int cppid = getppid();
  1f:	e8 2f 03 00 00       	call   353 <getppid>
        assert(ppid == cppid);
  24:	39 c3                	cmp    %eax,%ebx
  26:	74 22                	je     4a <main+0x4a>
  28:	6a 0e                	push   $0xe
  2a:	68 78 07 00 00       	push   $0x778
  2f:	68 9c 07 00 00       	push   $0x79c
  34:	6a 01                	push   $0x1
  36:	e8 e5 03 00 00       	call   420 <printf>
  3b:	e8 73 02 00 00       	call   2b3 <exit>
        printf(1, "test success: %d %d\n", ppid, cppid);
        exit();
    }
    wait();
  40:	e8 76 02 00 00       	call   2bb <wait>
#else // GETPPID
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 1c 08 00 00 	movzbl 0x81c(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 48b:	0f 84 ff 00 00 00    	je     590 <printf+0x170>
 491:	83 e8 63             	sub    $0x63,%eax
 494:	83 f8 15             	cmp    $0x15,%eax
 497:	77 17                	ja     4b0 <printf+0x90>
 499:	ff 24 85 c4 07 00 00 	jmp    *0x7c4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 524:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 527:	e8 a7 fd ff ff       	call   2d3 <write>
        ap++;
 52c:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
 530:	83 c4 10             	add    $0x10,%esp
      state = 0;
 533:	31 c9                	xor    %ecx,%ecx
 535:	e9 38 ff ff ff       	jmp    472 <printf+0x52>
 ...
 54d:	74 51                	je     5a0 <printf+0x180>
        while(*s != 0){
 54f:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
 552:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
 554:	84 c0                	test   %al,%al
 556:	0f 84 16 ff ff ff    	je     472 <printf+0x52>
 55c:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 ...
 573:	57                   	push   %edi
 574:	56                   	push   %esi
 575:	e8 59 fd ff ff       	call   2d3 <write>
        while(*s != 0){
 57a:	0f b6 03             	movzbl (%ebx),%eax
 57d:	83 c4 10             	add    $0x10,%esp
 580:	84 c0                	test   %al,%al
 582:	75 e4                	jne    568 <printf+0x148>
      state = 0;
 584:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
 587:	31 c9                	xor    %ecx,%ecx
 589:	e9 e4 fe ff ff       	jmp    472 <printf+0x52>
 58e:	66 90                	xchg   %ax,%ax
        putc(fd, c);
 590:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 593:	83 ec 04             	sub    $0x4,%esp
 596:	e9 32 ff ff ff       	jmp    4cd <printf+0xad>
 59b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 59f:	90                   	nop
          s = "(null)";
 5a0:	ba bd 07 00 00       	mov    $0x7bd,%edx
        while(*s != 0){
 5a5:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 5a8:	b8 28 00 00 00       	mov    $0x28,%eax
 5ad:	89 d3                	mov    %edx,%ebx
 5af:	eb b7                	jmp    568 <printf+0x148>
...
free(void *ap)
{
 ...
 5c1:	a1 00 0b 00 00       	mov    0xb00,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 00 0b 00 00    	mov    %edx,0xb00
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 00 0b 00 00    	mov    %edx,0xb00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 00 0b 00 00    	mov    0xb00,%edx
 ...
 6fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 00 0b 00 00    	mov    %edx,0xb00
}
 ...
 70f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 00 0b 00 00 04 	movl   $0xb04,0xb00
 717:	0b 00 00 
    base.s.size = 0;
 71a:	bf 04 0b 00 00       	mov    $0xb04,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 732:	00 00 00 
    if(p->s.size >= nunits){
...
void srand(unsigned seed) {
 ...
 756:	5d                   	pop    %ebp
    next = seed;
 757:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 75c:	c3                   	ret    
...
int rand(void) {
 ...
 760:	69 05 fc 0a 00 00 6d 	imul   $0x41c64e6d,0xafc,%eax
 767:	4e c6 41 
 76a:	05 39 30 00 00       	add    $0x3039,%eax
 76f:	a3 fc 0a 00 00       	mov    %eax,0xafc
    return((unsigned)(next/65536) % RAND_MAX);
 774:	c1 e8 10             	shr    $0x10,%eax
}
 777:	c3                   	ret    
