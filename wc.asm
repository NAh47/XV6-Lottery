 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 4c9:	0f b6 92 30 09 00 00 	movzbl 0x930(%edx),%edx
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5ab:	0f 84 ff 00 00 00    	je     6b0 <printf+0x170>
 5b1:	83 e8 63             	sub    $0x63,%eax
 5b4:	83 f8 15             	cmp    $0x15,%eax
 5b7:	77 17                	ja     5d0 <printf+0x90>
 5b9:	ff 24 85 d8 08 00 00 	jmp    *0x8d8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 644:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 647:	e8 a7 fd ff ff       	call   3f3 <write>
        ap++;
 64c:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
 650:	83 c4 10             	add    $0x10,%esp
      state = 0;
 653:	31 c9                	xor    %ecx,%ecx
 655:	e9 38 ff ff ff       	jmp    592 <printf+0x52>
 ...
 66d:	74 51                	je     6c0 <printf+0x180>
        while(*s != 0){
 66f:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
 672:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
 674:	84 c0                	test   %al,%al
 676:	0f 84 16 ff ff ff    	je     592 <printf+0x52>
 67c:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 ...
 68e:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 691:	6a 01                	push   $0x1
 693:	57                   	push   %edi
 694:	56                   	push   %esi
 695:	e8 59 fd ff ff       	call   3f3 <write>
        while(*s != 0){
 69a:	0f b6 03             	movzbl (%ebx),%eax
 69d:	83 c4 10             	add    $0x10,%esp
 6a0:	84 c0                	test   %al,%al
 6a2:	75 e4                	jne    688 <printf+0x148>
      state = 0;
 6a4:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
 6a7:	31 c9                	xor    %ecx,%ecx
 6a9:	e9 e4 fe ff ff       	jmp    592 <printf+0x52>
 6ae:	66 90                	xchg   %ax,%ax
        putc(fd, c);
 6b0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 6b3:	83 ec 04             	sub    $0x4,%esp
 6b6:	e9 32 ff ff ff       	jmp    5ed <printf+0xad>
 6bb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 6bf:	90                   	nop
          s = "(null)";
 6c0:	ba cf 08 00 00       	mov    $0x8cf,%edx
        while(*s != 0){
 6c5:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 6c8:	b8 28 00 00 00       	mov    $0x28,%eax
 6cd:	89 d3                	mov    %edx,%ebx
 6cf:	eb b7                	jmp    688 <printf+0x148>
 ...
 6e1:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 60 0e 00 00    	mov    %edx,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
...
void srand(unsigned seed) {
 ...
 876:	5d                   	pop    %ebp
    next = seed;
 877:	a3 4c 0c 00 00       	mov    %eax,0xc4c
}
 87c:	c3                   	ret    
...
int rand(void) {
 ...
 880:	69 05 4c 0c 00 00 6d 	imul   $0x41c64e6d,0xc4c,%eax
 887:	4e c6 41 
 88a:	05 39 30 00 00       	add    $0x3039,%eax
 88f:	a3 4c 0c 00 00       	mov    %eax,0xc4c
    return((unsigned)(next/65536) % RAND_MAX);
 894:	c1 e8 10             	shr    $0x10,%eax
}
 897:	c3                   	ret    
