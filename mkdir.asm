 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 d4 07 00 00 	jmp    *0x7d4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5bf:	90                   	nop
          s = "(null)";
 5c0:	ba cb 07 00 00       	mov    $0x7cb,%edx
        while(*s != 0){
 ...
 5e1:	a1 1c 0b 00 00       	mov    0xb1c,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 1c 0b 00 00    	mov    0xb1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 1c 0b 00 00    	mov    0xb1c,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 1c 0b 00 00    	mov    0xb1c,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 1c 0b 00 00 20 	movl   $0xb20,0xb1c
 737:	0b 00 00 
    base.s.size = 0;
 73a:	bf 20 0b 00 00       	mov    $0xb20,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 20 0b 00 00 20 	movl   $0xb20,0xb20
 746:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 752:	00 00 00 
    if(p->s.size >= nunits){
...
void srand(unsigned seed) {
 ...
 776:	5d                   	pop    %ebp
    next = seed;
 777:	a3 18 0b 00 00       	mov    %eax,0xb18
}
 77c:	c3                   	ret    
...
int rand(void) {
 ...
 780:	69 05 18 0b 00 00 6d 	imul   $0x41c64e6d,0xb18,%eax
 787:	4e c6 41 
 78a:	05 39 30 00 00       	add    $0x3039,%eax
 78f:	a3 18 0b 00 00       	mov    %eax,0xb18
