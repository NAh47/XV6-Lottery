...
main(int argc, char **argv){
  ...
  2c:	83 c4 10             	add    $0x10,%esp
	...
	exit();
  2f:	e8 9f 02 00 00       	call   2d3 <exit>
		nice_val=atoi(argv[1]);
  34:	83 ec 0c             	sub    $0xc,%esp
  37:	ff 77 04             	push   0x4(%edi)
		for(int i=2;i<argc;i++){
  ...
  64:	e8 1a 03 00 00       	call   383 <renice>
		for(int i=2;i<argc;i++){
  69:	83 c4 10             	add    $0x10,%esp
  6c:	39 f3                	cmp    %esi,%ebx
  6e:	75 e0                	jne    50 <main+0x50>
  70:	eb bd                	jmp    2f <main+0x2f>
  72:	66 90                	xchg   %ax,%ax
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 10 08 00 00 	movzbl 0x810(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4ab:	0f 84 ff 00 00 00    	je     5b0 <printf+0x170>
 4b1:	83 e8 63             	sub    $0x63,%eax
 4b4:	83 f8 15             	cmp    $0x15,%eax
 4b7:	77 17                	ja     4d0 <printf+0x90>
 4b9:	ff 24 85 b8 07 00 00 	jmp    *0x7b8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 544:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 547:	e8 a7 fd ff ff       	call   2f3 <write>
        ap++;
 54c:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
 550:	83 c4 10             	add    $0x10,%esp
      state = 0;
 553:	31 c9                	xor    %ecx,%ecx
 555:	e9 38 ff ff ff       	jmp    492 <printf+0x52>
 ...
 56d:	74 51                	je     5c0 <printf+0x180>
        while(*s != 0){
 56f:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
 572:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
 574:	84 c0                	test   %al,%al
 576:	0f 84 16 ff ff ff    	je     492 <printf+0x52>
 57c:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 ...
 593:	57                   	push   %edi
 594:	56                   	push   %esi
 595:	e8 59 fd ff ff       	call   2f3 <write>
        while(*s != 0){
 59a:	0f b6 03             	movzbl (%ebx),%eax
 59d:	83 c4 10             	add    $0x10,%esp
 5a0:	84 c0                	test   %al,%al
 5a2:	75 e4                	jne    588 <printf+0x148>
      state = 0;
 5a4:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
 5a7:	31 c9                	xor    %ecx,%ecx
 5a9:	e9 e4 fe ff ff       	jmp    492 <printf+0x52>
 5ae:	66 90                	xchg   %ax,%ax
        putc(fd, c);
 5b0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 5b3:	83 ec 04             	sub    $0x4,%esp
 5b6:	e9 32 ff ff ff       	jmp    4ed <printf+0xad>
 5bb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 5bf:	90                   	nop
          s = "(null)";
 5c0:	ba ae 07 00 00       	mov    $0x7ae,%edx
        while(*s != 0){
 5c5:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 5c8:	b8 28 00 00 00       	mov    $0x28,%eax
 5cd:	89 d3                	mov    %edx,%ebx
 5cf:	eb b7                	jmp    588 <printf+0x148>
 ...
 5e1:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 fc 0a 00 00    	mov    %edx,0xafc
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 fc 0a 00 00    	mov    %edx,0xafc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 fc 0a 00 00    	mov    %edx,0xafc
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 737:	0b 00 00 
    base.s.size = 0;
 73a:	bf 00 0b 00 00       	mov    $0xb00,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 746:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 752:	00 00 00 
    if(p->s.size >= nunits){
...
void srand(unsigned seed) {
 ...
 776:	5d                   	pop    %ebp
    next = seed;
 777:	a3 f8 0a 00 00       	mov    %eax,0xaf8
}
 77c:	c3                   	ret    
...
int rand(void) {
 ...
 780:	69 05 f8 0a 00 00 6d 	imul   $0x41c64e6d,0xaf8,%eax
 787:	4e c6 41 
 78a:	05 39 30 00 00       	add    $0x3039,%eax
