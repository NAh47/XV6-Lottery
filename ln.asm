 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 59f:	90                   	nop
          s = "(null)";
 5a0:	ba 9f 07 00 00       	mov    $0x79f,%edx
        while(*s != 0){
 ...
 5c1:	a1 e4 0a 00 00       	mov    0xae4,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 e4 0a 00 00    	mov    %edx,0xae4
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 e4 0a 00 00    	mov    %edx,0xae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
 ...
 70f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 e4 0a 00 00 e8 	movl   $0xae8,0xae4
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf e8 0a 00 00       	mov    $0xae8,%edi
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 e8 0a 00 00 e8 	movl   $0xae8,0xae8
 726:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 732:	00 00 00 
    if(p->s.size >= nunits){
...
int rand(void) {
 ...
 760:	69 05 e0 0a 00 00 6d 	imul   $0x41c64e6d,0xae0,%eax
 767:	4e c6 41 
