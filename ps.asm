 ...
 32c:	89 d1                	mov    %edx,%ecx
{
 ...
 359:	0f b6 92 88 07 00 00 	movzbl 0x788(%edx),%edx
 ...
 3d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 43b:	0f 84 ff 00 00 00    	je     540 <printf+0x170>
 441:	83 e8 63             	sub    $0x63,%eax
 444:	83 f8 15             	cmp    $0x15,%eax
 447:	77 17                	ja     460 <printf+0x90>
 449:	ff 24 85 30 07 00 00 	jmp    *0x730(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 4d4:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 4d7:	e8 a7 fd ff ff       	call   283 <write>
        ap++;
 4dc:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
 4e0:	83 c4 10             	add    $0x10,%esp
      state = 0;
 4e3:	31 c9                	xor    %ecx,%ecx
 4e5:	e9 38 ff ff ff       	jmp    422 <printf+0x52>
 ...
 4fd:	74 51                	je     550 <printf+0x180>
        while(*s != 0){
 4ff:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
 502:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
 504:	84 c0                	test   %al,%al
 506:	0f 84 16 ff ff ff    	je     422 <printf+0x52>
 50c:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 ...
 51e:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 521:	6a 01                	push   $0x1
 523:	57                   	push   %edi
 524:	56                   	push   %esi
 525:	e8 59 fd ff ff       	call   283 <write>
        while(*s != 0){
 52a:	0f b6 03             	movzbl (%ebx),%eax
 52d:	83 c4 10             	add    $0x10,%esp
 530:	84 c0                	test   %al,%al
 532:	75 e4                	jne    518 <printf+0x148>
      state = 0;
 534:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
 537:	31 c9                	xor    %ecx,%ecx
 539:	e9 e4 fe ff ff       	jmp    422 <printf+0x52>
 53e:	66 90                	xchg   %ax,%ax
        putc(fd, c);
 540:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 543:	83 ec 04             	sub    $0x4,%esp
 546:	e9 32 ff ff ff       	jmp    47d <printf+0xad>
 54b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 54f:	90                   	nop
          s = "(null)";
 550:	ba 28 07 00 00       	mov    $0x728,%edx
        while(*s != 0){
 555:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 558:	b8 28 00 00 00       	mov    $0x28,%eax
 55d:	89 d3                	mov    %edx,%ebx
 55f:	eb b7                	jmp    518 <printf+0x148>
...
free(void *ap)
{
 ...
 571:	a1 60 0a 00 00       	mov    0xa60,%eax
{
 ...
 5b1:	5b                   	pop    %ebx
  freep = p;
 5b2:	89 15 60 0a 00 00    	mov    %edx,0xa60
}
 5b8:	5e                   	pop    %esi
 5b9:	5f                   	pop    %edi
 5ba:	5d                   	pop    %ebp
 ...
 5e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5ec:	89 15 60 0a 00 00    	mov    %edx,0xa60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 609:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 60c:	8b 3d 60 0a 00 00    	mov    0xa60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 64f:	73 4f                	jae    6a0 <malloc+0xa0>
    ...
    if(p == freep)
 651:	8b 3d 60 0a 00 00    	mov    0xa60,%edi
 ...
 67a:	e8 f1 fe ff ff       	call   570 <free>
  return freep;
 67f:	8b 15 60 0a 00 00    	mov    0xa60,%edx
 ...
 6ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6af:	89 15 60 0a 00 00    	mov    %edx,0xa60
}
 ...
 6bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6c0:	c7 05 60 0a 00 00 64 	movl   $0xa64,0xa60
 6c7:	0a 00 00 
    base.s.size = 0;
 6ca:	bf 64 0a 00 00       	mov    $0xa64,%edi
    base.s.ptr = freep = prevp = &base;
 6cf:	c7 05 64 0a 00 00 64 	movl   $0xa64,0xa64
 6d6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6db:	c7 05 68 0a 00 00 00 	movl   $0x0,0xa68
 6e2:	00 00 00 
    if(p->s.size >= nunits){
...
void srand(unsigned seed) {
 ...
 706:	5d                   	pop    %ebp
    next = seed;
 707:	a3 5c 0a 00 00       	mov    %eax,0xa5c
}
 70c:	c3                   	ret    
...
int rand(void) {
 ...
 710:	69 05 5c 0a 00 00 6d 	imul   $0x41c64e6d,0xa5c,%eax
 717:	4e c6 41 
 71a:	05 39 30 00 00       	add    $0x3039,%eax
 71f:	a3 5c 0a 00 00       	mov    %eax,0xa5c
    return((unsigned)(next/65536) % RAND_MAX);
 724:	c1 e8 10             	shr    $0x10,%eax
}
 727:	c3                   	ret    
