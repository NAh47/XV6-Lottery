     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 40 1a 00 00       	push   $0x1a40
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 40 1a 00 00       	push   $0x1a40
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 38 1a 00 00       	push   $0x1a38
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 40 1a 00 00       	push   $0x1a40
     ...
     eec:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f19:	0f b6 92 30 14 00 00 	movzbl 0x1430(%edx),%edx
     ...
     f99:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     ffb:	0f 84 ff 00 00 00    	je     1100 <printf+0x170>
    1001:	83 e8 63             	sub    $0x63,%eax
    1004:	83 f8 15             	cmp    $0x15,%eax
    1007:	77 17                	ja     1020 <printf+0x90>
    1009:	ff 24 85 d8 13 00 00 	jmp    *0x13d8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    107b:	b9 0a 00 00 00       	mov    $0xa,%ecx
    1080:	6a 01                	push   $0x1
    1082:	eb d6                	jmp    105a <printf+0xca>
  ...
  write(fd, &c, 1);
    ...
    1093:	56                   	push   %esi
        putc(fd, *ap);
    1094:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    1097:	e8 a7 fd ff ff       	call   e43 <write>
        ap++;
    109c:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    10a0:	83 c4 10             	add    $0x10,%esp
      state = 0;
    10a3:	31 c9                	xor    %ecx,%ecx
    10a5:	e9 38 ff ff ff       	jmp    fe2 <printf+0x52>
    ...
    10bd:	74 51                	je     1110 <printf+0x180>
        while(*s != 0){
    10bf:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
    10c2:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
    10c4:	84 c0                	test   %al,%al
    10c6:	0f 84 16 ff ff ff    	je     fe2 <printf+0x52>
    10cc:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    10cf:	89 d3                	mov    %edx,%ebx
    10d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    10d8:	83 ec 04             	sub    $0x4,%esp
          s++;
    10db:	83 c3 01             	add    $0x1,%ebx
    10de:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    10e1:	6a 01                	push   $0x1
    10e3:	57                   	push   %edi
    10e4:	56                   	push   %esi
    10e5:	e8 59 fd ff ff       	call   e43 <write>
        while(*s != 0){
    10ea:	0f b6 03             	movzbl (%ebx),%eax
    10ed:	83 c4 10             	add    $0x10,%esp
    10f0:	84 c0                	test   %al,%al
    10f2:	75 e4                	jne    10d8 <printf+0x148>
      state = 0;
    10f4:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    10f7:	31 c9                	xor    %ecx,%ecx
    10f9:	e9 e4 fe ff ff       	jmp    fe2 <printf+0x52>
    10fe:	66 90                	xchg   %ax,%ax
        putc(fd, c);
    1100:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    1103:	83 ec 04             	sub    $0x4,%esp
    1106:	e9 32 ff ff ff       	jmp    103d <printf+0xad>
    110b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    110f:	90                   	nop
          s = "(null)";
    1110:	ba d0 13 00 00       	mov    $0x13d0,%edx
        while(*s != 0){
    1115:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    1118:	b8 28 00 00 00       	mov    $0x28,%eax
    111d:	89 d3                	mov    %edx,%ebx
    111f:	eb b7                	jmp    10d8 <printf+0x148>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1131:	a1 c4 1a 00 00       	mov    0x1ac4,%eax
{
  ...
  freep = p;
    ...
    1171:	5b                   	pop    %ebx
  freep = p;
    1172:	89 15 c4 1a 00 00    	mov    %edx,0x1ac4
}
    1178:	5e                   	pop    %esi
    1179:	5f                   	pop    %edi
    117a:	5d                   	pop    %ebp
  ...
  freep = p;
    11ac:	89 15 c4 1a 00 00    	mov    %edx,0x1ac4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11cc:	8b 3d c4 1a 00 00    	mov    0x1ac4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1211:	8b 3d c4 1a 00 00    	mov    0x1ac4,%edi
  ...
  return freep;
    123f:	8b 15 c4 1a 00 00    	mov    0x1ac4,%edx
    ...
    126c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    126f:	89 15 c4 1a 00 00    	mov    %edx,0x1ac4
}
    ...
    127f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1280:	c7 05 c4 1a 00 00 c8 	movl   $0x1ac8,0x1ac4
    1287:	1a 00 00 
    base.s.size = 0;
    128a:	bf c8 1a 00 00       	mov    $0x1ac8,%edi
    base.s.ptr = freep = prevp = &base;
    128f:	c7 05 c8 1a 00 00 c8 	movl   $0x1ac8,0x1ac8
    1296:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1299:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    129b:	c7 05 cc 1a 00 00 00 	movl   $0x0,0x1acc
    12a2:	00 00 00 
    if(p->s.size >= nunits){
...
void srand(unsigned seed) {
    ...
    12c6:	5d                   	pop    %ebp
    next = seed;
    12c7:	a3 48 1a 00 00       	mov    %eax,0x1a48
}
    12cc:	c3                   	ret    
...
int rand(void) {
    ...
    12d0:	69 05 48 1a 00 00 6d 	imul   $0x41c64e6d,0x1a48,%eax
    12d7:	4e c6 41 
    12da:	05 39 30 00 00       	add    $0x3039,%eax
    12df:	a3 48 1a 00 00       	mov    %eax,0x1a48
    return((unsigned)(next/65536) % RAND_MAX);
    12e4:	c1 e8 10             	shr    $0x10,%eax
}
    12e7:	c3                   	ret    
