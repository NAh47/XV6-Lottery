...
main(int argc, char **argv){
  ...
  20:	e8 fe 02 00 00       	call   323 <getpid>
  25:	5a                   	pop    %edx
  26:	59                   	pop    %ecx
  27:	50                   	push   %eax
  28:	56                   	push   %esi
  29:	e8 25 03 00 00       	call   353 <renice>
	exec(argv[2],&argv[2]);
  2e:	5e                   	pop    %esi
  2f:	58                   	pop    %eax
  30:	8d 43 08             	lea    0x8(%ebx),%eax
  33:	50                   	push   %eax
  34:	ff 73 08             	push   0x8(%ebx)
  37:	e8 9f 02 00 00       	call   2db <exec>
	exit();
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 47b:	0f 84 ff 00 00 00    	je     580 <printf+0x170>
 ...
 513:	56                   	push   %esi
        putc(fd, *ap);
 514:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 517:	e8 a7 fd ff ff       	call   2c3 <write>
        ap++;
 51c:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
 520:	83 c4 10             	add    $0x10,%esp
      state = 0;
 523:	31 c9                	xor    %ecx,%ecx
 525:	e9 38 ff ff ff       	jmp    462 <printf+0x52>
 ...
 53d:	74 51                	je     590 <printf+0x180>
        while(*s != 0){
 53f:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
 542:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
 544:	84 c0                	test   %al,%al
 546:	0f 84 16 ff ff ff    	je     462 <printf+0x52>
 54c:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 54f:	89 d3                	mov    %edx,%ebx
 551:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
 558:	83 ec 04             	sub    $0x4,%esp
          s++;
 55b:	83 c3 01             	add    $0x1,%ebx
 55e:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 561:	6a 01                	push   $0x1
 563:	57                   	push   %edi
 564:	56                   	push   %esi
 565:	e8 59 fd ff ff       	call   2c3 <write>
        while(*s != 0){
 56a:	0f b6 03             	movzbl (%ebx),%eax
 56d:	83 c4 10             	add    $0x10,%esp
 570:	84 c0                	test   %al,%al
 572:	75 e4                	jne    558 <printf+0x148>
      state = 0;
 574:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
 577:	31 c9                	xor    %ecx,%ecx
 579:	e9 e4 fe ff ff       	jmp    462 <printf+0x52>
 57e:	66 90                	xchg   %ax,%ax
        putc(fd, c);
 580:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 583:	83 ec 04             	sub    $0x4,%esp
 586:	e9 32 ff ff ff       	jmp    4bd <printf+0xad>
 58b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 58f:	90                   	nop
          s = "(null)";
 590:	ba 68 07 00 00       	mov    $0x768,%edx
        while(*s != 0){
 595:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 598:	b8 28 00 00 00       	mov    $0x28,%eax
 59d:	89 d3                	mov    %edx,%ebx
 59f:	eb b7                	jmp    558 <printf+0x148>
...
void srand(unsigned seed) {
 ...
 746:	5d                   	pop    %ebp
    next = seed;
 747:	a3 ac 0a 00 00       	mov    %eax,0xaac
}
 74c:	c3                   	ret    
...
int rand(void) {
 ...
 750:	69 05 ac 0a 00 00 6d 	imul   $0x41c64e6d,0xaac,%eax
 757:	4e c6 41 
 75a:	05 39 30 00 00       	add    $0x3039,%eax
 75f:	a3 ac 0a 00 00       	mov    %eax,0xaac
    return((unsigned)(next/65536) % RAND_MAX);
 764:	c1 e8 10             	shr    $0x10,%eax
}
 767:	c3                   	ret    
