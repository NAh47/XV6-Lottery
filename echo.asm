 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 49b:	0f 84 ff 00 00 00    	je     5a0 <printf+0x170>
 ...
 534:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 537:	e8 a7 fd ff ff       	call   2e3 <write>
        ap++;
 53c:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
 540:	83 c4 10             	add    $0x10,%esp
      state = 0;
 543:	31 c9                	xor    %ecx,%ecx
 545:	e9 38 ff ff ff       	jmp    482 <printf+0x52>
 ...
 55d:	74 51                	je     5b0 <printf+0x180>
        while(*s != 0){
 55f:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
 562:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
 564:	84 c0                	test   %al,%al
 566:	0f 84 16 ff ff ff    	je     482 <printf+0x52>
 56c:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 ...
 583:	57                   	push   %edi
 584:	56                   	push   %esi
 585:	e8 59 fd ff ff       	call   2e3 <write>
        while(*s != 0){
 58a:	0f b6 03             	movzbl (%ebx),%eax
 58d:	83 c4 10             	add    $0x10,%esp
 590:	84 c0                	test   %al,%al
 592:	75 e4                	jne    578 <printf+0x148>
      state = 0;
 594:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
 597:	31 c9                	xor    %ecx,%ecx
 599:	e9 e4 fe ff ff       	jmp    482 <printf+0x52>
 59e:	66 90                	xchg   %ax,%ax
        putc(fd, c);
 5a0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 5a3:	83 ec 04             	sub    $0x4,%esp
 5a6:	e9 32 ff ff ff       	jmp    4dd <printf+0xad>
 5ab:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 5af:	90                   	nop
          s = "(null)";
 5b0:	ba 91 07 00 00       	mov    $0x791,%edx
        while(*s != 0){
 5b5:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 5b8:	b8 28 00 00 00       	mov    $0x28,%eax
 5bd:	89 d3                	mov    %edx,%ebx
 5bf:	eb b7                	jmp    578 <printf+0x148>
...
void srand(unsigned seed) {
 ...
 766:	5d                   	pop    %ebp
    next = seed;
 767:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 76c:	c3                   	ret    
...
int rand(void) {
 ...
 770:	69 05 d8 0a 00 00 6d 	imul   $0x41c64e6d,0xad8,%eax
 777:	4e c6 41 
 77a:	05 39 30 00 00       	add    $0x3039,%eax
 77f:	a3 d8 0a 00 00       	mov    %eax,0xad8
    return((unsigned)(next/65536) % RAND_MAX);
 784:	c1 e8 10             	shr    $0x10,%eax
}
 787:	c3                   	ret    
