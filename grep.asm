 ...
 68c:	89 d1                	mov    %edx,%ecx
{
 ...
 6b9:	0f b6 92 20 0b 00 00 	movzbl 0xb20(%edx),%edx
 ...
 739:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 79b:	0f 84 ff 00 00 00    	je     8a0 <printf+0x170>
 7a1:	83 e8 63             	sub    $0x63,%eax
 7a4:	83 f8 15             	cmp    $0x15,%eax
 7a7:	77 17                	ja     7c0 <printf+0x90>
 7a9:	ff 24 85 c8 0a 00 00 	jmp    *0xac8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 833:	56                   	push   %esi
        putc(fd, *ap);
 834:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 837:	e8 a7 fd ff ff       	call   5e3 <write>
        ap++;
 83c:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
 840:	83 c4 10             	add    $0x10,%esp
      state = 0;
 843:	31 c9                	xor    %ecx,%ecx
 845:	e9 38 ff ff ff       	jmp    782 <printf+0x52>
 ...
 85d:	74 51                	je     8b0 <printf+0x180>
        while(*s != 0){
 85f:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
 862:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
 864:	84 c0                	test   %al,%al
 866:	0f 84 16 ff ff ff    	je     782 <printf+0x52>
 86c:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 ...
 87e:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 881:	6a 01                	push   $0x1
 883:	57                   	push   %edi
 884:	56                   	push   %esi
 885:	e8 59 fd ff ff       	call   5e3 <write>
        while(*s != 0){
 88a:	0f b6 03             	movzbl (%ebx),%eax
 88d:	83 c4 10             	add    $0x10,%esp
 890:	84 c0                	test   %al,%al
 892:	75 e4                	jne    878 <printf+0x148>
      state = 0;
 894:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
 897:	31 c9                	xor    %ecx,%ecx
 899:	e9 e4 fe ff ff       	jmp    782 <printf+0x52>
 89e:	66 90                	xchg   %ax,%ax
        putc(fd, c);
 8a0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 8a3:	83 ec 04             	sub    $0x4,%esp
 8a6:	e9 32 ff ff ff       	jmp    7dd <printf+0xad>
 8ab:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 8af:	90                   	nop
          s = "(null)";
 8b0:	ba be 0a 00 00       	mov    $0xabe,%edx
        while(*s != 0){
 8b5:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 8b8:	b8 28 00 00 00       	mov    $0x28,%eax
 8bd:	89 d3                	mov    %edx,%ebx
 8bf:	eb b7                	jmp    878 <printf+0x148>
...
free(void *ap)
{
 ...
 8d1:	a1 00 13 00 00       	mov    0x1300,%eax
{
 ...
 911:	5b                   	pop    %ebx
  freep = p;
 912:	89 15 00 13 00 00    	mov    %edx,0x1300
}
 918:	5e                   	pop    %esi
 919:	5f                   	pop    %edi
 91a:	5d                   	pop    %ebp
 ...
 949:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 94c:	89 15 00 13 00 00    	mov    %edx,0x1300
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 969:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 96c:	8b 3d 00 13 00 00    	mov    0x1300,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9af:	73 4f                	jae    a00 <malloc+0xa0>
    ...
    if(p == freep)
 9b1:	8b 3d 00 13 00 00    	mov    0x1300,%edi
 ...
 9da:	e8 f1 fe ff ff       	call   8d0 <free>
  return freep;
 9df:	8b 15 00 13 00 00    	mov    0x1300,%edx
 ...
 a0c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a0f:	89 15 00 13 00 00    	mov    %edx,0x1300
}
 ...
 a1f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a20:	c7 05 00 13 00 00 04 	movl   $0x1304,0x1300
 a27:	13 00 00 
    base.s.size = 0;
 a2a:	bf 04 13 00 00       	mov    $0x1304,%edi
    base.s.ptr = freep = prevp = &base;
 a2f:	c7 05 04 13 00 00 04 	movl   $0x1304,0x1304
 a36:	13 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a39:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a3b:	c7 05 08 13 00 00 00 	movl   $0x0,0x1308
 a42:	00 00 00 
    if(p->s.size >= nunits){
...
void srand(unsigned seed) {
 ...
 a66:	5d                   	pop    %ebp
    next = seed;
 a67:	a3 f4 0e 00 00       	mov    %eax,0xef4
}
 a6c:	c3                   	ret    
...
int rand(void) {
 ...
 a70:	69 05 f4 0e 00 00 6d 	imul   $0x41c64e6d,0xef4,%eax
 a77:	4e c6 41 
 a7a:	05 39 30 00 00       	add    $0x3039,%eax
 a7f:	a3 f4 0e 00 00       	mov    %eax,0xef4
    return((unsigned)(next/65536) % RAND_MAX);
 a84:	c1 e8 10             	shr    $0x10,%eax
}
 a87:	c3                   	ret    
