 ...
 3f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 45b:	0f 84 ff 00 00 00    	je     560 <printf+0x170>
 461:	83 e8 63             	sub    $0x63,%eax
 464:	83 f8 15             	cmp    $0x15,%eax
 467:	77 17                	ja     480 <printf+0x90>
 469:	ff 24 85 50 07 00 00 	jmp    *0x750(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 4f4:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 4f7:	e8 a7 fd ff ff       	call   2a3 <write>
        ap++;
 4fc:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
 500:	83 c4 10             	add    $0x10,%esp
      state = 0;
 503:	31 c9                	xor    %ecx,%ecx
 505:	e9 38 ff ff ff       	jmp    442 <printf+0x52>
 ...
 51d:	74 51                	je     570 <printf+0x180>
        while(*s != 0){
 51f:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
 522:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
 524:	84 c0                	test   %al,%al
 526:	0f 84 16 ff ff ff    	je     442 <printf+0x52>
 52c:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 52f:	89 d3                	mov    %edx,%ebx
 ...
 543:	57                   	push   %edi
 544:	56                   	push   %esi
 545:	e8 59 fd ff ff       	call   2a3 <write>
        while(*s != 0){
 ...
 552:	75 e4                	jne    538 <printf+0x148>
      state = 0;
 554:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
 557:	31 c9                	xor    %ecx,%ecx
 559:	e9 e4 fe ff ff       	jmp    442 <printf+0x52>
 55e:	66 90                	xchg   %ax,%ax
        putc(fd, c);
 560:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 563:	83 ec 04             	sub    $0x4,%esp
 566:	e9 32 ff ff ff       	jmp    49d <printf+0xad>
 56b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 56f:	90                   	nop
          s = "(null)";
 570:	ba 48 07 00 00       	mov    $0x748,%edx
        while(*s != 0){
 575:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 578:	b8 28 00 00 00       	mov    $0x28,%eax
 57d:	89 d3                	mov    %edx,%ebx
 57f:	eb b7                	jmp    538 <printf+0x148>
 ...
 591:	a1 88 0a 00 00       	mov    0xa88,%eax
{
 ...
 5d1:	5b                   	pop    %ebx
  freep = p;
 5d2:	89 15 88 0a 00 00    	mov    %edx,0xa88
}
 5d8:	5e                   	pop    %esi
 5d9:	5f                   	pop    %edi
 5da:	5d                   	pop    %ebp
 ...
 609:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 60c:	89 15 88 0a 00 00    	mov    %edx,0xa88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 3d 88 0a 00 00    	mov    0xa88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66f:	73 4f                	jae    6c0 <malloc+0xa0>
    ...
    if(p == freep)
 671:	8b 3d 88 0a 00 00    	mov    0xa88,%edi
 ...
 69a:	e8 f1 fe ff ff       	call   590 <free>
  return freep;
 69f:	8b 15 88 0a 00 00    	mov    0xa88,%edx
 ...
 6cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 88 0a 00 00    	mov    %edx,0xa88
}
 ...
 6df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 88 0a 00 00 8c 	movl   $0xa8c,0xa88
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	bf 8c 0a 00 00       	mov    $0xa8c,%edi
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 8c 0a 00 00 8c 	movl   $0xa8c,0xa8c
 6f6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6fb:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 702:	00 00 00 
    if(p->s.size >= nunits){
...
void srand(unsigned seed) {
 ...
 726:	5d                   	pop    %ebp
    next = seed;
 727:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 72c:	c3                   	ret    
...
int rand(void) {
 ...
 730:	69 05 84 0a 00 00 6d 	imul   $0x41c64e6d,0xa84,%eax
 737:	4e c6 41 
 73a:	05 39 30 00 00       	add    $0x3039,%eax
 73f:	a3 84 0a 00 00       	mov    %eax,0xa84
    return((unsigned)(next/65536) % RAND_MAX);
 744:	c1 e8 10             	shr    $0x10,%eax
}
 747:	c3                   	ret    
