 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 56b:	0f 84 ff 00 00 00    	je     670 <printf+0x170>
 571:	83 e8 63             	sub    $0x63,%eax
 574:	83 f8 15             	cmp    $0x15,%eax
 577:	77 17                	ja     590 <printf+0x90>
 579:	ff 24 85 84 08 00 00 	jmp    *0x884(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 604:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 607:	e8 a7 fd ff ff       	call   3b3 <write>
        ap++;
 60c:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
 610:	83 c4 10             	add    $0x10,%esp
      state = 0;
 613:	31 c9                	xor    %ecx,%ecx
 615:	e9 38 ff ff ff       	jmp    552 <printf+0x52>
 ...
 62d:	74 51                	je     680 <printf+0x180>
        while(*s != 0){
 62f:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
 632:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
 634:	84 c0                	test   %al,%al
 636:	0f 84 16 ff ff ff    	je     552 <printf+0x52>
 63c:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 63f:	89 d3                	mov    %edx,%ebx
 ...
 653:	57                   	push   %edi
 654:	56                   	push   %esi
 655:	e8 59 fd ff ff       	call   3b3 <write>
        while(*s != 0){
 65a:	0f b6 03             	movzbl (%ebx),%eax
 65d:	83 c4 10             	add    $0x10,%esp
 660:	84 c0                	test   %al,%al
 662:	75 e4                	jne    648 <printf+0x148>
      state = 0;
 664:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
 667:	31 c9                	xor    %ecx,%ecx
 669:	e9 e4 fe ff ff       	jmp    552 <printf+0x52>
 66e:	66 90                	xchg   %ax,%ax
        putc(fd, c);
 670:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 673:	83 ec 04             	sub    $0x4,%esp
 676:	e9 32 ff ff ff       	jmp    5ad <printf+0xad>
 67b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 67f:	90                   	nop
          s = "(null)";
 680:	ba 7b 08 00 00       	mov    $0x87b,%edx
        while(*s != 0){
 685:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
 688:	b8 28 00 00 00       	mov    $0x28,%eax
 68d:	89 d3                	mov    %edx,%ebx
 68f:	eb b7                	jmp    648 <printf+0x148>
...
void srand(unsigned seed) {
 ...
 836:	5d                   	pop    %ebp
    next = seed;
 837:	a3 c8 0b 00 00       	mov    %eax,0xbc8
}
 83c:	c3                   	ret    
...
int rand(void) {
 ...
 840:	69 05 c8 0b 00 00 6d 	imul   $0x41c64e6d,0xbc8,%eax
 847:	4e c6 41 
 84a:	05 39 30 00 00       	add    $0x3039,%eax
 84f:	a3 c8 0b 00 00       	mov    %eax,0xbc8
    return((unsigned)(next/65536) % RAND_MAX);
 854:	c1 e8 10             	shr    $0x10,%eax
}
 857:	c3                   	ret    
