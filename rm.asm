 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5bf:	90                   	nop
          s = "(null)";
 5c0:	ba c5 07 00 00       	mov    $0x7c5,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 14 0b 00 00       	mov    0xb14,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 14 0b 00 00    	mov    %edx,0xb14
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 14 0b 00 00    	mov    %edx,0xb14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 14 0b 00 00    	mov    0xb14,%edx
 ...
 737:	0b 00 00 
    base.s.size = 0;
 73a:	bf 18 0b 00 00       	mov    $0xb18,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 1c 0b 00 00 00 	movl   $0x0,0xb1c
 752:	00 00 00 
    if(p->s.size >= nunits){
...
void srand(unsigned seed) {
 ...
 776:	5d                   	pop    %ebp
    next = seed;
 777:	a3 10 0b 00 00       	mov    %eax,0xb10
}
 77c:	c3                   	ret    
...
int rand(void) {
 ...
 780:	69 05 10 0b 00 00 6d 	imul   $0x41c64e6d,0xb10,%eax
 787:	4e c6 41 
 78a:	05 39 30 00 00       	add    $0x3039,%eax
 78f:	a3 10 0b 00 00       	mov    %eax,0xb10
