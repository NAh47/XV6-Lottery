...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1bf:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1d6:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1ed:	ff 35 84 5e 00 00    	push   0x5e84
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 84 5e 00 00    	push   0x5e84
     ...
     2a0:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    exit();
     ...
     2ce:	ff 35 84 5e 00 00    	push   0x5e84
     ...
     2e5:	ff 35 84 5e 00 00    	push   0x5e84
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     356:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 84 5e 00 00    	push   0x5e84
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     47f:	ff 35 84 5e 00 00    	push   0x5e84
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 84 5e 00 00    	push   0x5e84
     ...
     5de:	ff 35 84 5e 00 00    	push   0x5e84
     ...
     5f7:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     60e:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "read failed\n");
     ...
     625:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "unlink small failed\n");
     ...
     63c:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     653:	ff 35 84 5e 00 00    	push   0x5e84
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 84 5e 00 00    	push   0x5e84
     ...
     793:	ff 35 84 5e 00 00    	push   0x5e84
     ...
     7aa:	ff 35 84 5e 00 00    	push   0x5e84
     ...
     7c3:	ff 35 84 5e 00 00    	push   0x5e84
     ...
     7de:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7f5:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     80c:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "unlink big failed\n");
     ...
     823:	ff 35 84 5e 00 00    	push   0x5e84
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 84 5e 00 00    	push   0x5e84
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     98f:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9a6:	ff 35 84 5e 00 00    	push   0x5e84
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9bd:	ff 35 84 5e 00 00    	push   0x5e84
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 84 5e 00 00    	push   0x5e84
     9e1:	e8 3a 30 00 00       	call   3a20 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 88 5e 00 00       	push   $0x5e88
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 84 5e 00 00    	push   0x5e84
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  pid = fork();
     a3d:	e8 69 2e 00 00       	call   38ab <fork>
  if(pid == 0){
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 79 2e 00 00       	call   38db <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 4e 2e 00 00       	call   38cb <read>
     ...
     abd:	6a 01                	push   $0x1
     abf:	e8 5c 2f 00 00       	call   3a20 <printf>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 ff 2d 00 00       	call   38db <close>
     ...
     b11:	e8 bd 2d 00 00       	call   38d3 <write>
    ...
    exit();
     b28:	e8 86 2d 00 00       	call   38b3 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 9a 2d 00 00       	call   38db <close>
    wait();
     b41:	e8 75 2d 00 00       	call   38bb <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 b4 2e 00 00       	call   3a20 <printf>
      exit();
     b6c:	e8 42 2d 00 00       	call   38b3 <exit>
    ...
    exit();
     b7f:	e8 2f 2d 00 00       	call   38b3 <exit>
    ...
    exit();
     b92:	e8 1c 2d 00 00       	call   38b3 <exit>
     ...
     ba0:	e8 7b 2e 00 00       	call   3a20 <printf>
        exit();
     ba5:	e8 09 2d 00 00       	call   38b3 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 e1 2c 00 00       	call   38ab <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 cc 2c 00 00       	call   38ab <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 c7 2c 00 00       	call   38c3 <pipe>
  pid3 = fork();
     bfc:	e8 aa 2c 00 00       	call   38ab <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 9d 2c 00 00       	call   38db <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 60 2c 00 00       	call   38db <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 52 2c 00 00       	call   38e3 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 4a 2c 00 00       	call   38e3 <kill>
  kill(pid3);
  ...
  wait();
     caf:	e8 07 2c 00 00       	call   38bb <wait>
  wait();
     cb4:	e8 02 2c 00 00       	call   38bb <wait>
  wait();
     cb9:	e8 fd 2b 00 00       	call   38bb <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
    ...
    printf(1, "preempt read error");
     ...
     cf3:	6a 01                	push   $0x1
     cf5:	e8 26 2d 00 00       	call   3a20 <printf>
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 94 2b 00 00       	call   38bb <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 76 2b 00 00       	call   38ab <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 24 2b 00 00       	call   38b3 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 88 2b 00 00       	call   3933 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 f9 2a 00 00       	call   38ab <fork>
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     dcc:	e8 7f 2e 00 00       	call   3c50 <malloc>
    ...
    while(m1){
     ...
     de5:	8b 36                	mov    (%esi),%esi
      free(m1);
     de7:	50                   	push   %eax
     de8:	e8 d3 2d 00 00       	call   3bc0 <free>
    while(m1){
    ...
    m1 = malloc(1024*20);
     ...
     dfc:	e8 4f 2e 00 00       	call   3c50 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     e0b:	50                   	push   %eax
     e0c:	e8 af 2d 00 00       	call   3bc0 <free>
    printf(1, "mem ok\n");
     e11:	58                   	pop    %eax
     e12:	5a                   	pop    %edx
    ...
    exit();
     e1f:	e8 8f 2a 00 00       	call   38b3 <exit>
     ...
     e3a:	e8 a4 2a 00 00       	call   38e3 <kill>
      exit();
     e3f:	e8 6f 2a 00 00       	call   38b3 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 68 2a 00 00       	jmp    38bb <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 82 2a 00 00       	call   3903 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 b3 41 00 00       	push   $0x41b3
     e8d:	e8 61 2a 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 ff 29 00 00       	call   38ab <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 f2 29 00 00       	call   38d3 <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 b0 29 00 00       	call   38bb <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 c2 29 00 00       	call   38db <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 b3 41 00 00       	push   $0x41b3
     f22:	e8 cc 29 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 7a 29 00 00       	call   38cb <read>
  ...
  close(fd);
     ...
     f86:	e8 50 29 00 00       	call   38db <close>
  unlink("sharedfd");
     f8b:	c7 04 24 b3 41 00 00 	movl   $0x41b3,(%esp)
     f92:	e8 6c 29 00 00       	call   3903 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 b3 28 00 00       	call   38b3 <exit>
    ...
    exit();
    100e:	e8 a0 28 00 00       	call   38b3 <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 9f 28 00 00       	call   3903 <unlink>
    pid = fork();
    1064:	e8 42 28 00 00       	call   38ab <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 2e 28 00 00       	call   38bb <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 27 28 00 00       	call   38bb <wait>
    1094:	e8 22 28 00 00       	call   38bb <wait>
    1099:	e8 1d 28 00 00       	call   38bb <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 41 28 00 00       	call   38f3 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 f6 27 00 00       	call   38cb <read>
    ...
    1104:	e8 d2 27 00 00       	call   38db <close>
    if(total != 12*500){
    ...
    111e:	e8 e0 27 00 00       	call   3903 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 c2 28 00 00       	call   3a20 <printf>
          exit();
    115e:	e8 50 27 00 00       	call   38b3 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 82 27 00 00       	call   38f3 <open>
      if(fd < 0){
    ...
    1190:	e8 8b 25 00 00       	call   3720 <memset>
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 28 27 00 00       	call   38d3 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 f4 26 00 00       	call   38b3 <exit>
    ...
    11c8:	e8 53 28 00 00       	call   3a20 <printf>
        exit();
    11cd:	e8 e1 26 00 00       	call   38b3 <exit>
    ...
    11e2:	e8 39 28 00 00       	call   3a20 <printf>
      exit();
    11e7:	e8 c7 26 00 00       	call   38b3 <exit>
    ...
    11f5:	e8 26 28 00 00       	call   3a20 <printf>
      exit();
    11fa:	e8 b4 26 00 00       	call   38b3 <exit>
    ...
    1208:	e8 13 28 00 00       	call   3a20 <printf>
          exit();
    120d:	e8 a1 26 00 00       	call   38b3 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 6c 26 00 00       	call   38ab <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 61 26 00 00       	call   38bb <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 57 26 00 00       	call   38bb <wait>
    1264:	e8 52 26 00 00       	call   38bb <wait>
    1269:	e8 4d 26 00 00       	call   38bb <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 45 26 00 00       	call   38f3 <open>
      if((i == 0 || i >= N/2) && fd < 0){
  ...
  printf(1, "createdelete ok\n");
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 54 25 00 00       	call   38f3 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 2c 25 00 00       	call   38db <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 35 25 00 00       	call   3903 <unlink>
    ...
    13dc:	6a 01                	push   $0x1
    13de:	e8 3d 26 00 00       	call   3a20 <printf>
            exit();
    13e3:	e8 cb 24 00 00       	call   38b3 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 be 24 00 00       	call   38b3 <exit>
        printf(1, "oops createdelete %s didn't exist\n", name);
    13f5:	83 ec 04             	sub    $0x4,%esp
    13f8:	57                   	push   %edi
    13f9:	68 f0 4e 00 00       	push   $0x4ef0
    13fe:	6a 01                	push   $0x1
    1400:	e8 1b 26 00 00       	call   3a20 <printf>
        exit();
    1405:	e8 a9 24 00 00       	call   38b3 <exit>
      printf(1, "fork failed\n");
    140a:	83 ec 08             	sub    $0x8,%esp
    140d:	68 b9 4c 00 00       	push   $0x4cb9
    1412:	6a 01                	push   $0x1
    1414:	e8 07 26 00 00       	call   3a20 <printf>
      exit();
    1419:	e8 95 24 00 00       	call   38b3 <exit>
          printf(1, "create failed\n");
    141e:	83 ec 08             	sub    $0x8,%esp
    1421:	68 7f 44 00 00       	push   $0x447f
    1426:	6a 01                	push   $0x1
    1428:	e8 f3 25 00 00       	call   3a20 <printf>
          exit();
    142d:	e8 81 24 00 00       	call   38b3 <exit>
...
00001440 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    144d:	6a 01                	push   $0x1
    144f:	e8 cc 25 00 00       	call   3a20 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1454:	5b                   	pop    %ebx
    1455:	5e                   	pop    %esi
    1456:	68 02 02 00 00       	push   $0x202
    145b:	68 65 42 00 00       	push   $0x4265
    1460:	e8 8e 24 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 51 24 00 00       	call   38d3 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 51 24 00 00       	call   38db <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 65 42 00 00       	push   $0x4265
    1493:	e8 5b 24 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 51 24 00 00       	call   3903 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 24 24 00 00       	call   38f3 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 b2 23 00 00       	call   38d3 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 a9 23 00 00       	call   38db <close>
  unlink("unlinkread");
    1532:	c7 04 24 65 42 00 00 	movl   $0x4265,(%esp)
    1539:	e8 c5 23 00 00       	call   3903 <unlink>
  printf(1, "unlinkread ok\n");
    153e:	58                   	pop    %eax
    153f:	5a                   	pop    %edx
    1540:	68 0d 43 00 00       	push   $0x430d
    1545:	6a 01                	push   $0x1
    1547:	e8 d4 24 00 00       	call   3a20 <printf>
}
    ...
    155d:	6a 01                	push   $0x1
    155f:	e8 bc 24 00 00       	call   3a20 <printf>
    exit();
    1564:	e8 4a 23 00 00       	call   38b3 <exit>
    printf(1, "unlinkread write failed\n");
    1569:	51                   	push   %ecx
    156a:	51                   	push   %ecx
    156b:	68 f4 42 00 00       	push   $0x42f4
    1570:	6a 01                	push   $0x1
    1572:	e8 a9 24 00 00       	call   3a20 <printf>
    exit();
    1577:	e8 37 23 00 00       	call   38b3 <exit>
    printf(1, "unlinkread wrong data\n");
    157c:	53                   	push   %ebx
    157d:	53                   	push   %ebx
    157e:	68 dd 42 00 00       	push   $0x42dd
    1583:	6a 01                	push   $0x1
    1585:	e8 96 24 00 00       	call   3a20 <printf>
    exit();
    158a:	e8 24 23 00 00       	call   38b3 <exit>
    printf(1, "unlinkread read failed");
    158f:	56                   	push   %esi
    1590:	56                   	push   %esi
    1591:	68 c6 42 00 00       	push   $0x42c6
    1596:	6a 01                	push   $0x1
    1598:	e8 83 24 00 00       	call   3a20 <printf>
    exit();
    159d:	e8 11 23 00 00       	call   38b3 <exit>
    printf(1, "unlink unlinkread failed\n");
    15a2:	50                   	push   %eax
    15a3:	50                   	push   %eax
    15a4:	68 a8 42 00 00       	push   $0x42a8
    15a9:	6a 01                	push   $0x1
    15ab:	e8 70 24 00 00       	call   3a20 <printf>
    exit();
    15b0:	e8 fe 22 00 00       	call   38b3 <exit>
    printf(1, "open unlinkread failed\n");
    15b5:	50                   	push   %eax
    15b6:	50                   	push   %eax
    15b7:	68 90 42 00 00       	push   $0x4290
    15bc:	6a 01                	push   $0x1
    15be:	e8 5d 24 00 00       	call   3a20 <printf>
    exit();
    15c3:	e8 eb 22 00 00       	call   38b3 <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 aa 22 00 00       	call   38d3 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 9d 22 00 00       	call   38db <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 2a 43 00 00       	push   $0x432a
    1645:	68 26 43 00 00       	push   $0x4326
    164a:	e8 c4 22 00 00       	call   3913 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 9c 22 00 00       	call   3903 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 26 43 00 00       	push   $0x4326
    1670:	e8 7e 22 00 00       	call   38f3 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 64 22 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 1c 22 00 00       	call   38cb <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 17 22 00 00       	call   38db <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 2a 43 00 00       	push   $0x432a
    16cb:	68 2a 43 00 00       	push   $0x432a
    16d0:	e8 3e 22 00 00       	call   3913 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 16 22 00 00       	call   3903 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 26 43 00 00       	push   $0x4326
    16f4:	68 2a 43 00 00       	push   $0x432a
    16f9:	e8 15 22 00 00       	call   3913 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 fc 21 00 00       	call   3913 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    1726:	6a 01                	push   $0x1
    1728:	e8 f3 22 00 00       	call   3a20 <printf>
}
    ...
    173c:	6a 01                	push   $0x1
    173e:	e8 dd 22 00 00       	call   3a20 <printf>
    exit();
    1743:	e8 6b 21 00 00       	call   38b3 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1748:	50                   	push   %eax
    1749:	50                   	push   %eax
    174a:	68 a8 43 00 00       	push   $0x43a8
    174f:	6a 01                	push   $0x1
    1751:	e8 ca 22 00 00       	call   3a20 <printf>
    exit();
    1756:	e8 58 21 00 00       	call   38b3 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    175b:	52                   	push   %edx
    175c:	52                   	push   %edx
    175d:	68 5c 4f 00 00       	push   $0x4f5c
    1762:	6a 01                	push   $0x1
    1764:	e8 b7 22 00 00       	call   3a20 <printf>
    exit();
    1769:	e8 45 21 00 00       	call   38b3 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    176e:	50                   	push   %eax
    176f:	50                   	push   %eax
    1770:	68 8a 43 00 00       	push   $0x438a
    1775:	6a 01                	push   $0x1
    1777:	e8 a4 22 00 00       	call   3a20 <printf>
    exit();
    177c:	e8 32 21 00 00       	call   38b3 <exit>
    printf(1, "read lf2 failed\n");
    1781:	51                   	push   %ecx
    1782:	51                   	push   %ecx
    1783:	68 79 43 00 00       	push   $0x4379
    1788:	6a 01                	push   $0x1
    178a:	e8 91 22 00 00       	call   3a20 <printf>
    exit();
    178f:	e8 1f 21 00 00       	call   38b3 <exit>
    printf(1, "open lf2 failed\n");
    1794:	53                   	push   %ebx
    1795:	53                   	push   %ebx
    1796:	68 68 43 00 00       	push   $0x4368
    179b:	6a 01                	push   $0x1
    179d:	e8 7e 22 00 00       	call   3a20 <printf>
    exit();
    17a2:	e8 0c 21 00 00       	call   38b3 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    17a7:	50                   	push   %eax
    17a8:	50                   	push   %eax
    17a9:	68 34 4f 00 00       	push   $0x4f34
    17ae:	6a 01                	push   $0x1
    17b0:	e8 6b 22 00 00       	call   3a20 <printf>
    exit();
    17b5:	e8 f9 20 00 00       	call   38b3 <exit>
    printf(1, "link lf1 lf2 failed\n");
    17ba:	51                   	push   %ecx
    17bb:	51                   	push   %ecx
    17bc:	68 53 43 00 00       	push   $0x4353
    17c1:	6a 01                	push   $0x1
    17c3:	e8 58 22 00 00       	call   3a20 <printf>
    exit();
    17c8:	e8 e6 20 00 00       	call   38b3 <exit>
    printf(1, "write lf1 failed\n");
    17cd:	50                   	push   %eax
    17ce:	50                   	push   %eax
    17cf:	68 41 43 00 00       	push   $0x4341
    17d4:	6a 01                	push   $0x1
    17d6:	e8 45 22 00 00       	call   3a20 <printf>
    exit();
    17db:	e8 d3 20 00 00       	call   38b3 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    ...
    17f3:	6a 01                	push   $0x1
    17f5:	e8 26 22 00 00       	call   3a20 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 c4 20 00 00       	call   38f3 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 99 20 00 00       	call   38db <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 71 20 00 00       	call   38bb <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 a1 20 00 00       	call   3903 <unlink>
    pid = fork();
    1862:	e8 44 20 00 00       	call   38ab <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 69 20 00 00       	call   38f3 <open>
      if(fd < 0){
    ...
    189e:	6a 01                	push   $0x1
    18a0:	e8 7b 21 00 00       	call   3a20 <printf>
        exit();
    18a5:	e8 09 20 00 00       	call   38b3 <exit>
    18aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      link("C0", file);
    18b0:	83 ec 08             	sub    $0x8,%esp
    18b3:	53                   	push   %ebx
    18b4:	68 e1 43 00 00       	push   $0x43e1
    18b9:	e8 55 20 00 00       	call   3913 <link>
    18be:	83 c4 10             	add    $0x10,%esp
      exit();
    18c1:	e8 ed 1f 00 00       	call   38b3 <exit>
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 32 20 00 00       	call   3913 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 d2 1f 00 00       	call   38bb <wait>
  for(i = 0; i < 40; i++){
  ...
  memset(fa, 0, sizeof(fa));
    ...
    18fa:	6a 00                	push   $0x0
    18fc:	50                   	push   %eax
    18fd:	e8 1e 1e 00 00       	call   3720 <memset>
  fd = open(".", 0);
    1902:	5e                   	pop    %esi
    1903:	5f                   	pop    %edi
    1904:	6a 00                	push   $0x0
    ...
    190e:	e8 e0 1f 00 00       	call   38f3 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 9f 1f 00 00       	call   38cb <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 62 1f 00 00       	call   38db <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 ca 1e 00 00       	call   38ab <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 e3 1e 00 00       	call   38f3 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 c3 1e 00 00       	call   38db <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 d1 1e 00 00       	call   38f3 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 b1 1e 00 00       	call   38db <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 bf 1e 00 00       	call   38f3 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 9f 1e 00 00       	call   38db <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 ad 1e 00 00       	call   38f3 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 8d 1e 00 00       	call   38db <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a68:	6a 01                	push   $0x1
    1a6a:	e8 b1 1f 00 00       	call   3a20 <printf>
}
    ...
    1a7f:	6a 01                	push   $0x1
    1a81:	e8 9a 1f 00 00       	call   3a20 <printf>
      exit();
    1a86:	e8 28 1e 00 00       	call   38b3 <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a8b:	51                   	push   %ecx
    1a8c:	51                   	push   %ecx
    1a8d:	68 80 4f 00 00       	push   $0x4f80
    1a92:	6a 01                	push   $0x1
    1a94:	e8 87 1f 00 00       	call   3a20 <printf>
    exit();
    1a99:	e8 15 1e 00 00       	call   38b3 <exit>
    ...
    1aaa:	6a 01                	push   $0x1
    1aac:	e8 6f 1f 00 00       	call   3a20 <printf>
        exit();
    1ab1:	e8 fd 1d 00 00       	call   38b3 <exit>
    ...
    1ac2:	6a 01                	push   $0x1
    1ac4:	e8 57 1f 00 00       	call   3a20 <printf>
        exit();
    1ac9:	e8 e5 1d 00 00       	call   38b3 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 04 1e 00 00       	call   38db <close>
...
00001ae0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1aee:	6a 01                	push   $0x1
    1af0:	e8 2b 1f 00 00       	call   3a20 <printf>
  unlink("x");
    1af5:	c7 04 24 d1 46 00 00 	movl   $0x46d1,(%esp)
    1afc:	e8 02 1e 00 00       	call   3903 <unlink>
  pid = fork();
    1b01:	e8 a5 1d 00 00       	call   38ab <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 c1 1d 00 00       	call   3903 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 78 1d 00 00       	call   38f3 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 58 1d 00 00       	call   38db <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 24 1d 00 00       	call   38bb <wait>
  printf(1, "linkunlink ok\n");
    1b97:	83 ec 08             	sub    $0x8,%esp
    1b9a:	68 59 44 00 00       	push   $0x4459
    1b9f:	6a 01                	push   $0x1
    1ba1:	e8 7a 1e 00 00       	call   3a20 <printf>
}
    ...
    1bbd:	e8 51 1d 00 00       	call   3913 <link>
    ...
    1bd1:	6a 01                	push   $0x1
    1bd3:	e8 48 1e 00 00       	call   3a20 <printf>
    exit();
    1bd8:	e8 d6 1c 00 00       	call   38b3 <exit>
    exit();
    1bdd:	e8 d1 1c 00 00       	call   38b3 <exit>
...
00001bf0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    ...
    1bfe:	6a 01                	push   $0x1
    1c00:	e8 1b 1e 00 00       	call   3a20 <printf>
  unlink("bd");
    1c05:	c7 04 24 75 44 00 00 	movl   $0x4475,(%esp)
    1c0c:	e8 f2 1c 00 00       	call   3903 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 75 44 00 00       	push   $0x4475
    1c1d:	e8 d1 1c 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 a0 1c 00 00       	call   38db <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 a7 1c 00 00       	call   3913 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 76 1c 00 00       	call   3903 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 4c 1c 00 00       	call   3903 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1cd1:	6a 01                	push   $0x1
    1cd3:	e8 48 1d 00 00       	call   3a20 <printf>
    ...
    1ceb:	6a 01                	push   $0x1
    1ced:	e8 2e 1d 00 00       	call   3a20 <printf>
      exit();
    1cf2:	e8 bc 1b 00 00       	call   38b3 <exit>
      printf(1, "bigdir unlink failed");
    1cf7:	83 ec 08             	sub    $0x8,%esp
    1cfa:	68 a2 44 00 00       	push   $0x44a2
    1cff:	6a 01                	push   $0x1
    1d01:	e8 1a 1d 00 00       	call   3a20 <printf>
      exit();
    1d06:	e8 a8 1b 00 00       	call   38b3 <exit>
    printf(1, "bigdir create failed\n");
    1d0b:	50                   	push   %eax
    1d0c:	50                   	push   %eax
    1d0d:	68 78 44 00 00       	push   $0x4478
    1d12:	6a 01                	push   $0x1
    1d14:	e8 07 1d 00 00       	call   3a20 <printf>
    exit();
    1d19:	e8 95 1b 00 00       	call   38b3 <exit>
...
00001d20 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    ...
    1d2c:	6a 01                	push   $0x1
    1d2e:	e8 ed 1c 00 00       	call   3a20 <printf>
  unlink("ff");
    1d33:	c7 04 24 4b 45 00 00 	movl   $0x454b,(%esp)
    1d3a:	e8 c4 1b 00 00       	call   3903 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 e8 45 00 00 	movl   $0x45e8,(%esp)
    1d46:	e8 d0 1b 00 00       	call   391b <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 8b 1b 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 4e 1b 00 00       	call   38d3 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 4e 1b 00 00       	call   38db <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 e8 45 00 00 	movl   $0x45e8,(%esp)
    1d94:	e8 6a 1b 00 00       	call   3903 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 6a 1b 00 00       	call   391b <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 25 1b 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 e8 1a 00 00       	call   38d3 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 e8 1a 00 00       	call   38db <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 42 45 00 00       	push   $0x4542
    1dfc:	e8 f2 1a 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 aa 1a 00 00       	call   38cb <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 98 1a 00 00       	call   38db <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 82 45 00 00       	push   $0x4582
    1e4a:	68 1e 45 00 00       	push   $0x451e
    1e4f:	e8 bf 1a 00 00       	call   3913 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 97 1a 00 00       	call   3903 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 6d 1a 00 00       	call   38f3 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 85 1a 00 00       	call   3923 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 6d 1a 00 00       	call   3923 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 55 1a 00 00       	call   3923 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 3d 1a 00 00       	call   3923 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 f3 19 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 ab 19 00 00       	call   38cb <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 a6 19 00 00       	call   38db <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 1e 45 00 00       	push   $0x451e
    1f3e:	e8 b0 19 00 00       	call   38f3 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 93 19 00 00       	call   38f3 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 76 19 00 00       	call   38f3 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 59 19 00 00       	call   38f3 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 3f 19 00 00       	call   38f3 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 25 19 00 00       	call   38f3 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 28 19 00 00       	call   3913 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 0b 19 00 00       	call   3913 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 ee 18 00 00       	call   3913 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 de 18 00 00       	call   391b <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 c6 18 00 00       	call   391b <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 ae 18 00 00       	call   391b <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 7e 18 00 00       	call   3903 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 66 18 00 00       	call   3903 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 6e 18 00 00       	call   3923 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 56 18 00 00       	call   3923 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 1e 18 00 00       	call   3903 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 06 18 00 00       	call   3903 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 ee 17 00 00       	call   3903 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 d6 17 00 00       	call   3903 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 be 17 00 00       	call   3903 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    2158:	6a 01                	push   $0x1
    215a:	e8 c1 18 00 00       	call   3a20 <printf>
}
    ...
    216e:	6a 01                	push   $0x1
    2170:	e8 ab 18 00 00       	call   3a20 <printf>
    exit();
    2175:	e8 39 17 00 00       	call   38b3 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    217a:	50                   	push   %eax
    217b:	50                   	push   %eax
    217c:	68 c2 45 00 00       	push   $0x45c2
    2181:	6a 01                	push   $0x1
    2183:	e8 98 18 00 00       	call   3a20 <printf>
    exit();
    2188:	e8 26 17 00 00       	call   38b3 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    218d:	50                   	push   %eax
    218e:	50                   	push   %eax
    218f:	68 8d 45 00 00       	push   $0x458d
    2194:	6a 01                	push   $0x1
    2196:	e8 85 18 00 00       	call   3a20 <printf>
    exit();
    219b:	e8 13 17 00 00       	call   38b3 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    21a0:	51                   	push   %ecx
    21a1:	51                   	push   %ecx
    21a2:	68 3f 46 00 00       	push   $0x463f
    21a7:	6a 01                	push   $0x1
    21a9:	e8 72 18 00 00       	call   3a20 <printf>
    exit();
    21ae:	e8 00 17 00 00       	call   38b3 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    21b3:	53                   	push   %ebx
    21b4:	53                   	push   %ebx
    21b5:	68 24 50 00 00       	push   $0x5024
    21ba:	6a 01                	push   $0x1
    21bc:	e8 5f 18 00 00       	call   3a20 <printf>
    exit();
    21c1:	e8 ed 16 00 00       	call   38b3 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    21c6:	51                   	push   %ecx
    21c7:	51                   	push   %ecx
    21c8:	68 d3 46 00 00       	push   $0x46d3
    21cd:	6a 01                	push   $0x1
    21cf:	e8 4c 18 00 00       	call   3a20 <printf>
    exit();
    21d4:	e8 da 16 00 00       	call   38b3 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21d9:	53                   	push   %ebx
    21da:	53                   	push   %ebx
    21db:	68 94 50 00 00       	push   $0x5094
    21e0:	6a 01                	push   $0x1
    21e2:	e8 39 18 00 00       	call   3a20 <printf>
    exit();
    21e7:	e8 c7 16 00 00       	call   38b3 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    21ec:	50                   	push   %eax
    21ed:	50                   	push   %eax
    21ee:	68 4e 45 00 00       	push   $0x454e
    21f3:	6a 01                	push   $0x1
    21f5:	e8 26 18 00 00       	call   3a20 <printf>
    exit();
    21fa:	e8 b4 16 00 00       	call   38b3 <exit>
    printf(1, "create dd/dd/ff failed\n");
    21ff:	51                   	push   %ecx
    2200:	51                   	push   %ecx
    2201:	68 27 45 00 00       	push   $0x4527
    2206:	6a 01                	push   $0x1
    2208:	e8 13 18 00 00       	call   3a20 <printf>
    exit();
    220d:	e8 a1 16 00 00       	call   38b3 <exit>
    printf(1, "chdir ./.. failed\n");
    2212:	50                   	push   %eax
    2213:	50                   	push   %eax
    2214:	68 f0 45 00 00       	push   $0x45f0
    2219:	6a 01                	push   $0x1
    221b:	e8 00 18 00 00       	call   3a20 <printf>
    exit();
    2220:	e8 8e 16 00 00       	call   38b3 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2225:	52                   	push   %edx
    2226:	52                   	push   %edx
    2227:	68 dc 4f 00 00       	push   $0x4fdc
    222c:	6a 01                	push   $0x1
    222e:	e8 ed 17 00 00       	call   3a20 <printf>
    exit();
    2233:	e8 7b 16 00 00       	call   38b3 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2238:	50                   	push   %eax
    2239:	50                   	push   %eax
    223a:	68 70 50 00 00       	push   $0x5070
    223f:	6a 01                	push   $0x1
    2241:	e8 da 17 00 00       	call   3a20 <printf>
    exit();
    2246:	e8 68 16 00 00       	call   38b3 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    224b:	50                   	push   %eax
    224c:	50                   	push   %eax
    224d:	68 4c 50 00 00       	push   $0x504c
    2252:	6a 01                	push   $0x1
    2254:	e8 c7 17 00 00       	call   3a20 <printf>
    exit();
    2259:	e8 55 16 00 00       	call   38b3 <exit>
    printf(1, "open dd wronly succeeded!\n");
    225e:	50                   	push   %eax
    225f:	50                   	push   %eax
    2260:	68 af 46 00 00       	push   $0x46af
    2265:	6a 01                	push   $0x1
    2267:	e8 b4 17 00 00       	call   3a20 <printf>
    exit();
    226c:	e8 42 16 00 00       	call   38b3 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2271:	50                   	push   %eax
    2272:	50                   	push   %eax
    2273:	68 96 46 00 00       	push   $0x4696
    2278:	6a 01                	push   $0x1
    227a:	e8 a1 17 00 00       	call   3a20 <printf>
    exit();
    227f:	e8 2f 16 00 00       	call   38b3 <exit>
    printf(1, "create dd succeeded!\n");
    2284:	50                   	push   %eax
    2285:	50                   	push   %eax
    2286:	68 80 46 00 00       	push   $0x4680
    228b:	6a 01                	push   $0x1
    228d:	e8 8e 17 00 00       	call   3a20 <printf>
    exit();
    2292:	e8 1c 16 00 00       	call   38b3 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2297:	52                   	push   %edx
    2298:	52                   	push   %edx
    2299:	68 64 46 00 00       	push   $0x4664
    229e:	6a 01                	push   $0x1
    22a0:	e8 7b 17 00 00       	call   3a20 <printf>
    exit();
    22a5:	e8 09 16 00 00       	call   38b3 <exit>
    printf(1, "chdir dd failed\n");
    22aa:	50                   	push   %eax
    22ab:	50                   	push   %eax
    22ac:	68 a5 45 00 00       	push   $0x45a5
    22b1:	6a 01                	push   $0x1
    22b3:	e8 68 17 00 00       	call   3a20 <printf>
    exit();
    22b8:	e8 f6 15 00 00       	call   38b3 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    22bf:	68 00 50 00 00       	push   $0x5000
    22c4:	6a 01                	push   $0x1
    22c6:	e8 55 17 00 00       	call   3a20 <printf>
    exit();
    22cb:	e8 e3 15 00 00       	call   38b3 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    22d0:	53                   	push   %ebx
    22d1:	53                   	push   %ebx
    22d2:	68 03 45 00 00       	push   $0x4503
    22d7:	6a 01                	push   $0x1
    22d9:	e8 42 17 00 00       	call   3a20 <printf>
    exit();
    22de:	e8 d0 15 00 00       	call   38b3 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22e3:	50                   	push   %eax
    22e4:	50                   	push   %eax
    22e5:	68 b4 4f 00 00       	push   $0x4fb4
    22ea:	6a 01                	push   $0x1
    22ec:	e8 2f 17 00 00       	call   3a20 <printf>
    exit();
    22f1:	e8 bd 15 00 00       	call   38b3 <exit>
    printf(1, "create dd/ff failed\n");
    22f6:	50                   	push   %eax
    22f7:	50                   	push   %eax
    22f8:	68 e7 44 00 00       	push   $0x44e7
    22fd:	6a 01                	push   $0x1
    22ff:	e8 1c 17 00 00       	call   3a20 <printf>
    exit();
    2304:	e8 aa 15 00 00       	call   38b3 <exit>
    printf(1, "subdir mkdir dd failed\n");
    2309:	50                   	push   %eax
    230a:	50                   	push   %eax
    230b:	68 cf 44 00 00       	push   $0x44cf
    2310:	6a 01                	push   $0x1
    2312:	e8 09 17 00 00       	call   3a20 <printf>
    exit();
    2317:	e8 97 15 00 00       	call   38b3 <exit>
    printf(1, "unlink dd failed\n");
    231c:	50                   	push   %eax
    231d:	50                   	push   %eax
    231e:	68 b8 47 00 00       	push   $0x47b8
    2323:	6a 01                	push   $0x1
    2325:	e8 f6 16 00 00       	call   3a20 <printf>
    exit();
    232a:	e8 84 15 00 00       	call   38b3 <exit>
    printf(1, "unlink dd/dd failed\n");
    232f:	52                   	push   %edx
    2330:	52                   	push   %edx
    2331:	68 a3 47 00 00       	push   $0x47a3
    2336:	6a 01                	push   $0x1
    2338:	e8 e3 16 00 00       	call   3a20 <printf>
    exit();
    233d:	e8 71 15 00 00       	call   38b3 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2342:	51                   	push   %ecx
    2343:	51                   	push   %ecx
    2344:	68 b8 50 00 00       	push   $0x50b8
    2349:	6a 01                	push   $0x1
    234b:	e8 d0 16 00 00       	call   3a20 <printf>
    exit();
    2350:	e8 5e 15 00 00       	call   38b3 <exit>
    printf(1, "unlink dd/ff failed\n");
    2355:	53                   	push   %ebx
    2356:	53                   	push   %ebx
    2357:	68 8e 47 00 00       	push   $0x478e
    235c:	6a 01                	push   $0x1
    235e:	e8 bd 16 00 00       	call   3a20 <printf>
    exit();
    2363:	e8 4b 15 00 00       	call   38b3 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2368:	50                   	push   %eax
    2369:	50                   	push   %eax
    236a:	68 76 47 00 00       	push   $0x4776
    236f:	6a 01                	push   $0x1
    2371:	e8 aa 16 00 00       	call   3a20 <printf>
    exit();
    2376:	e8 38 15 00 00       	call   38b3 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    237b:	50                   	push   %eax
    237c:	50                   	push   %eax
    237d:	68 5e 47 00 00       	push   $0x475e
    2382:	6a 01                	push   $0x1
    2384:	e8 97 16 00 00       	call   3a20 <printf>
    exit();
    2389:	e8 25 15 00 00       	call   38b3 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    238e:	50                   	push   %eax
    238f:	50                   	push   %eax
    2390:	68 42 47 00 00       	push   $0x4742
    2395:	6a 01                	push   $0x1
    2397:	e8 84 16 00 00       	call   3a20 <printf>
    exit();
    239c:	e8 12 15 00 00       	call   38b3 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    23a1:	50                   	push   %eax
    23a2:	50                   	push   %eax
    23a3:	68 26 47 00 00       	push   $0x4726
    23a8:	6a 01                	push   $0x1
    23aa:	e8 71 16 00 00       	call   3a20 <printf>
    exit();
    23af:	e8 ff 14 00 00       	call   38b3 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    23b4:	50                   	push   %eax
    23b5:	50                   	push   %eax
    23b6:	68 09 47 00 00       	push   $0x4709
    23bb:	6a 01                	push   $0x1
    23bd:	e8 5e 16 00 00       	call   3a20 <printf>
    exit();
    23c2:	e8 ec 14 00 00       	call   38b3 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    23c7:	52                   	push   %edx
    23c8:	52                   	push   %edx
    23c9:	68 ee 46 00 00       	push   $0x46ee
    23ce:	6a 01                	push   $0x1
    23d0:	e8 4b 16 00 00       	call   3a20 <printf>
    exit();
    23d5:	e8 d9 14 00 00       	call   38b3 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    23da:	51                   	push   %ecx
    23db:	51                   	push   %ecx
    23dc:	68 1b 46 00 00       	push   $0x461b
    23e1:	6a 01                	push   $0x1
    23e3:	e8 38 16 00 00       	call   3a20 <printf>
    exit();
    23e8:	e8 c6 14 00 00       	call   38b3 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    23ed:	53                   	push   %ebx
    23ee:	53                   	push   %ebx
    23ef:	68 03 46 00 00       	push   $0x4603
    23f4:	6a 01                	push   $0x1
    23f6:	e8 25 16 00 00       	call   3a20 <printf>
    exit();
    23fb:	e8 b3 14 00 00       	call   38b3 <exit>
...
00002400 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2412:	6a 01                	push   $0x1
    2414:	e8 07 16 00 00       	call   3a20 <printf>
  unlink("bigwrite");
    2419:	c7 04 24 e4 47 00 00 	movl   $0x47e4,(%esp)
    2420:	e8 de 14 00 00       	call   3903 <unlink>
    ...
    243d:	e8 b1 14 00 00       	call   38f3 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 79 14 00 00       	call   38d3 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 63 14 00 00       	call   38d3 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 55 14 00 00       	call   38db <close>
    unlink("bigwrite");
    2486:	c7 04 24 e4 47 00 00 	movl   $0x47e4,(%esp)
    248d:	e8 71 14 00 00       	call   3903 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24a5:	6a 01                	push   $0x1
    24a7:	e8 74 15 00 00       	call   3a20 <printf>
}
    ...
    24bd:	6a 01                	push   $0x1
    24bf:	e8 5c 15 00 00       	call   3a20 <printf>
        exit();
    24c4:	e8 ea 13 00 00       	call   38b3 <exit>
      printf(1, "cannot create bigwrite\n");
    24c9:	83 ec 08             	sub    $0x8,%esp
    24cc:	68 ed 47 00 00       	push   $0x47ed
    24d1:	6a 01                	push   $0x1
    24d3:	e8 48 15 00 00       	call   3a20 <printf>
      exit();
    24d8:	e8 d6 13 00 00       	call   38b3 <exit>
...
000024e0 <bigfile>:
{
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 85 13 00 00       	call   38d3 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 6e 13 00 00       	call   38db <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 40 48 00 00       	push   $0x4840
    2576:	e8 78 13 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 fa 12 00 00       	call   38cb <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 f8 12 00 00       	call   38db <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 04 13 00 00       	call   3903 <unlink>
  printf(1, "bigfile test ok\n");
    25ff:	58                   	pop    %eax
    2600:	5a                   	pop    %edx
    2601:	68 cf 48 00 00       	push   $0x48cf
    2606:	6a 01                	push   $0x1
    2608:	e8 13 14 00 00       	call   3a20 <printf>
}
    ...
    2620:	6a 01                	push   $0x1
    2622:	e8 f9 13 00 00       	call   3a20 <printf>
      exit();
    2627:	e8 87 12 00 00       	call   38b3 <exit>
      printf(1, "short read bigfile\n");
    262c:	83 ec 08             	sub    $0x8,%esp
    262f:	68 88 48 00 00       	push   $0x4888
    2634:	6a 01                	push   $0x1
    2636:	e8 e5 13 00 00       	call   3a20 <printf>
      exit();
    263b:	e8 73 12 00 00       	call   38b3 <exit>
      printf(1, "read bigfile failed\n");
    2640:	83 ec 08             	sub    $0x8,%esp
    2643:	68 73 48 00 00       	push   $0x4873
    2648:	6a 01                	push   $0x1
    264a:	e8 d1 13 00 00       	call   3a20 <printf>
      exit();
    264f:	e8 5f 12 00 00       	call   38b3 <exit>
      printf(1, "write bigfile failed\n");
    2654:	83 ec 08             	sub    $0x8,%esp
    2657:	68 48 48 00 00       	push   $0x4848
    265c:	6a 01                	push   $0x1
    265e:	e8 bd 13 00 00       	call   3a20 <printf>
      exit();
    2663:	e8 4b 12 00 00       	call   38b3 <exit>
    printf(1, "cannot open bigfile\n");
    2668:	53                   	push   %ebx
    2669:	53                   	push   %ebx
    266a:	68 5e 48 00 00       	push   $0x485e
    266f:	6a 01                	push   $0x1
    2671:	e8 aa 13 00 00       	call   3a20 <printf>
    exit();
    2676:	e8 38 12 00 00       	call   38b3 <exit>
    printf(1, "cannot create bigfile");
    267b:	50                   	push   %eax
    267c:	50                   	push   %eax
    267d:	68 32 48 00 00       	push   $0x4832
    2682:	6a 01                	push   $0x1
    2684:	e8 97 13 00 00       	call   3a20 <printf>
    exit();
    2689:	e8 25 12 00 00       	call   38b3 <exit>
    printf(1, "read bigfile wrong total\n");
    268e:	51                   	push   %ecx
    268f:	51                   	push   %ecx
    2690:	68 b5 48 00 00       	push   $0x48b5
    2695:	6a 01                	push   $0x1
    2697:	e8 84 13 00 00       	call   3a20 <printf>
    exit();
    269c:	e8 12 12 00 00       	call   38b3 <exit>
...
000026b0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    ...
    26bb:	6a 01                	push   $0x1
    26bd:	e8 5e 13 00 00       	call   3a20 <printf>
  if(mkdir("12345678901234") != 0){
    26c2:	c7 04 24 1b 49 00 00 	movl   $0x491b,(%esp)
    26c9:	e8 4d 12 00 00       	call   391b <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 35 12 00 00       	call   391b <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 f0 11 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 c4 11 00 00       	call   38db <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 98 51 00 00       	push   $0x5198
    2720:	e8 ce 11 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 a6 11 00 00       	call   38db <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 0c 49 00 00 	movl   $0x490c,(%esp)
    273c:	e8 da 11 00 00       	call   391b <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 c6 11 00 00       	call   391b <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    2764:	6a 01                	push   $0x1
    2766:	e8 b5 12 00 00       	call   3a20 <printf>
}
    ...
    2777:	6a 01                	push   $0x1
    2779:	e8 a2 12 00 00       	call   3a20 <printf>
    exit();
    277e:	e8 30 11 00 00       	call   38b3 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2783:	50                   	push   %eax
    2784:	50                   	push   %eax
    2785:	68 54 52 00 00       	push   $0x5254
    278a:	6a 01                	push   $0x1
    278c:	e8 8f 12 00 00       	call   3a20 <printf>
    exit();
    2791:	e8 1d 11 00 00       	call   38b3 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2796:	52                   	push   %edx
    2797:	52                   	push   %edx
    2798:	68 04 52 00 00       	push   $0x5204
    279d:	6a 01                	push   $0x1
    279f:	e8 7c 12 00 00       	call   3a20 <printf>
    exit();
    27a4:	e8 0a 11 00 00       	call   38b3 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    27a9:	51                   	push   %ecx
    27aa:	51                   	push   %ecx
    27ab:	68 c8 51 00 00       	push   $0x51c8
    27b0:	6a 01                	push   $0x1
    27b2:	e8 69 12 00 00       	call   3a20 <printf>
    exit();
    27b7:	e8 f7 10 00 00       	call   38b3 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    27bc:	51                   	push   %ecx
    27bd:	51                   	push   %ecx
    27be:	68 58 51 00 00       	push   $0x5158
    27c3:	6a 01                	push   $0x1
    27c5:	e8 56 12 00 00       	call   3a20 <printf>
    exit();
    27ca:	e8 e4 10 00 00       	call   38b3 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    27cf:	50                   	push   %eax
    27d0:	50                   	push   %eax
    27d1:	68 f8 50 00 00       	push   $0x50f8
    27d6:	6a 01                	push   $0x1
    27d8:	e8 43 12 00 00       	call   3a20 <printf>
    exit();
    27dd:	e8 d1 10 00 00       	call   38b3 <exit>
...
000027f0 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    ...
    27fb:	6a 01                	push   $0x1
    27fd:	e8 1e 12 00 00       	call   3a20 <printf>
  if(mkdir("dots") != 0){
    2802:	c7 04 24 43 49 00 00 	movl   $0x4943,(%esp)
    2809:	e8 0d 11 00 00       	call   391b <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 fd 10 00 00       	call   3923 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 c5 10 00 00       	call   3903 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 ad 10 00 00       	call   3903 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 b5 10 00 00       	call   3923 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 7d 10 00 00       	call   3903 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 69 10 00 00       	call   3903 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 55 10 00 00       	call   3903 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    28bd:	6a 01                	push   $0x1
    28bf:	e8 5c 11 00 00       	call   3a20 <printf>
}
    ...
    28d0:	6a 01                	push   $0x1
    28d2:	e8 49 11 00 00       	call   3a20 <printf>
    exit();
    28d7:	e8 d7 0f 00 00       	call   38b3 <exit>
    printf(1, "unlink dots failed!\n");
    28dc:	50                   	push   %eax
    28dd:	50                   	push   %eax
    28de:	68 c9 49 00 00       	push   $0x49c9
    28e3:	6a 01                	push   $0x1
    28e5:	e8 36 11 00 00       	call   3a20 <printf>
    exit();
    28ea:	e8 c4 0f 00 00       	call   38b3 <exit>
    printf(1, "unlink dots/.. worked!\n");
    28ef:	52                   	push   %edx
    28f0:	52                   	push   %edx
    28f1:	68 b1 49 00 00       	push   $0x49b1
    28f6:	6a 01                	push   $0x1
    28f8:	e8 23 11 00 00       	call   3a20 <printf>
    exit();
    28fd:	e8 b1 0f 00 00       	call   38b3 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    2904:	68 92 49 00 00       	push   $0x4992
    2909:	6a 01                	push   $0x1
    290b:	e8 10 11 00 00       	call   3a20 <printf>
    exit();
    2910:	e8 9e 0f 00 00       	call   38b3 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    2917:	68 c3 3d 00 00       	push   $0x3dc3
    291c:	6a 01                	push   $0x1
    291e:	e8 fd 10 00 00       	call   3a20 <printf>
    exit();
    2923:	e8 8b 0f 00 00       	call   38b3 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    292a:	68 7c 49 00 00       	push   $0x497c
    292f:	6a 01                	push   $0x1
    2931:	e8 ea 10 00 00       	call   3a20 <printf>
    exit();
    2936:	e8 78 0f 00 00       	call   38b3 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    293d:	68 6e 49 00 00       	push   $0x496e
    2942:	6a 01                	push   $0x1
    2944:	e8 d7 10 00 00       	call   3a20 <printf>
    exit();
    2949:	e8 65 0f 00 00       	call   38b3 <exit>
    printf(1, "chdir dots failed\n");
    294e:	50                   	push   %eax
    294f:	50                   	push   %eax
    2950:	68 5b 49 00 00       	push   $0x495b
    2955:	6a 01                	push   $0x1
    2957:	e8 c4 10 00 00       	call   3a20 <printf>
    exit();
    295c:	e8 52 0f 00 00       	call   38b3 <exit>
...
00002970 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    ...
    297c:	6a 01                	push   $0x1
    297e:	e8 9d 10 00 00       	call   3a20 <printf>
  fd = open("dirfile", O_CREATE);
    2983:	5b                   	pop    %ebx
    2984:	58                   	pop    %eax
    2985:	68 00 02 00 00       	push   $0x200
    298a:	68 f5 49 00 00       	push   $0x49f5
    298f:	e8 5f 0f 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 33 0f 00 00       	call   38db <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 f5 49 00 00 	movl   $0x49f5,(%esp)
    29af:	e8 6f 0f 00 00       	call   3923 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 25 0f 00 00       	call   38f3 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 08 0f 00 00       	call   38f3 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 18 0f 00 00       	call   391b <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 e8 0e 00 00       	call   3903 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 db 0e 00 00       	call   3913 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 b3 0e 00 00       	call   3903 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 89 0e 00 00       	call   38f3 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 6f 0e 00 00       	call   38f3 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 3d 0e 00 00       	call   38d3 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 35 0e 00 00       	call   38db <close>
  printf(1, "dir vs file OK\n");
    2aa6:	58                   	pop    %eax
    2aa7:	5a                   	pop    %edx
    2aa8:	68 c5 4a 00 00       	push   $0x4ac5
    2aad:	6a 01                	push   $0x1
    2aaf:	e8 6c 0f 00 00       	call   3a20 <printf>
}
    ...
    2ac3:	6a 01                	push   $0x1
    2ac5:	e8 56 0f 00 00       	call   3a20 <printf>
    exit();
    2aca:	e8 e4 0d 00 00       	call   38b3 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2acf:	52                   	push   %edx
    2ad0:	52                   	push   %edx
    2ad1:	68 14 4a 00 00       	push   $0x4a14
    2ad6:	6a 01                	push   $0x1
    2ad8:	e8 43 0f 00 00       	call   3a20 <printf>
    exit();
    2add:	e8 d1 0d 00 00       	call   38b3 <exit>
    printf(1, "create dirfile failed\n");
    2ae2:	51                   	push   %ecx
    2ae3:	51                   	push   %ecx
    2ae4:	68 fd 49 00 00       	push   $0x49fd
    2ae9:	6a 01                	push   $0x1
    2aeb:	e8 30 0f 00 00       	call   3a20 <printf>
    exit();
    2af0:	e8 be 0d 00 00       	call   38b3 <exit>
    printf(1, "write . succeeded!\n");
    2af5:	51                   	push   %ecx
    2af6:	51                   	push   %ecx
    2af7:	68 b1 4a 00 00       	push   $0x4ab1
    2afc:	6a 01                	push   $0x1
    2afe:	e8 1d 0f 00 00       	call   3a20 <printf>
    exit();
    2b03:	e8 ab 0d 00 00       	call   38b3 <exit>
    printf(1, "open . for writing succeeded!\n");
    2b08:	53                   	push   %ebx
    2b09:	53                   	push   %ebx
    2b0a:	68 a8 52 00 00       	push   $0x52a8
    2b0f:	6a 01                	push   $0x1
    2b11:	e8 0a 0f 00 00       	call   3a20 <printf>
    exit();
    2b16:	e8 98 0d 00 00       	call   38b3 <exit>
    printf(1, "unlink dirfile failed!\n");
    2b1b:	50                   	push   %eax
    2b1c:	50                   	push   %eax
    2b1d:	68 99 4a 00 00       	push   $0x4a99
    2b22:	6a 01                	push   $0x1
    2b24:	e8 f7 0e 00 00       	call   3a20 <printf>
    exit();
    2b29:	e8 85 0d 00 00       	call   38b3 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b2e:	50                   	push   %eax
    2b2f:	50                   	push   %eax
    2b30:	68 88 52 00 00       	push   $0x5288
    2b35:	6a 01                	push   $0x1
    2b37:	e8 e4 0e 00 00       	call   3a20 <printf>
    exit();
    2b3c:	e8 72 0d 00 00       	call   38b3 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2b41:	50                   	push   %eax
    2b42:	50                   	push   %eax
    2b43:	68 74 4a 00 00       	push   $0x4a74
    2b48:	6a 01                	push   $0x1
    2b4a:	e8 d1 0e 00 00       	call   3a20 <printf>
    exit();
    2b4f:	e8 5f 0d 00 00       	call   38b3 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2b54:	50                   	push   %eax
    2b55:	50                   	push   %eax
    2b56:	68 57 4a 00 00       	push   $0x4a57
    2b5b:	6a 01                	push   $0x1
    2b5d:	e8 be 0e 00 00       	call   3a20 <printf>
    exit();
    2b62:	e8 4c 0d 00 00       	call   38b3 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b81:	6a 01                	push   $0x1
    2b83:	e8 98 0e 00 00       	call   3a20 <printf>
    ...
    2b98:	e8 7e 0d 00 00       	call   391b <mkdir>
    ...
    2bb0:	e8 6e 0d 00 00       	call   3923 <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 b7 0c 00 00       	call   38db <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 d0 46 00 00       	push   $0x46d0
    2c2f:	e8 cf 0c 00 00       	call   3903 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 d6 0c 00 00       	call   3923 <chdir>
  printf(1, "empty file name OK\n");
    2c4d:	58                   	pop    %eax
    2c4e:	5a                   	pop    %edx
    2c4f:	68 14 4b 00 00       	push   $0x4b14
    2c54:	6a 01                	push   $0x1
    2c56:	e8 c5 0d 00 00       	call   3a20 <printf>
}
    ...
    2c6b:	6a 01                	push   $0x1
    2c6d:	e8 ae 0d 00 00       	call   3a20 <printf>
      exit();
    2c72:	e8 3c 0c 00 00       	call   38b3 <exit>
      printf(1, "chdir irefd failed\n");
    2c77:	83 ec 08             	sub    $0x8,%esp
    2c7a:	68 00 4b 00 00       	push   $0x4b00
    2c7f:	6a 01                	push   $0x1
    2c81:	e8 9a 0d 00 00       	call   3a20 <printf>
      exit();
    2c86:	e8 28 0c 00 00       	call   38b3 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    ...
    2c9e:	6a 01                	push   $0x1
    2ca0:	e8 7b 0d 00 00       	call   3a20 <printf>
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 e9 0b 00 00       	call   38ab <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 e6 0b 00 00       	call   38bb <wait>
  ...
  if(wait() != -1){
    2cde:	e8 d8 0b 00 00       	call   38bb <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cf0:	6a 01                	push   $0x1
    2cf2:	e8 29 0d 00 00       	call   3a20 <printf>
}
    2cf7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    2cfa:	c9                   	leave  
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 b2 0b 00 00       	call   38b3 <exit>
      printf(1, "wait stopped early\n");
    2d01:	83 ec 08             	sub    $0x8,%esp
    2d04:	68 33 4b 00 00       	push   $0x4b33
    2d09:	6a 01                	push   $0x1
    2d0b:	e8 10 0d 00 00       	call   3a20 <printf>
      exit();
    2d10:	e8 9e 0b 00 00       	call   38b3 <exit>
    printf(1, "wait got too many\n");
    2d15:	52                   	push   %edx
    2d16:	52                   	push   %edx
    2d17:	68 47 4b 00 00       	push   $0x4b47
    2d1c:	6a 01                	push   $0x1
    2d1e:	e8 fd 0c 00 00       	call   3a20 <printf>
    exit();
    2d23:	e8 8b 0b 00 00       	call   38b3 <exit>
    printf(1, "fork claimed to work 1000 times!\n");
    2d28:	50                   	push   %eax
    2d29:	50                   	push   %eax
    2d2a:	68 c8 52 00 00       	push   $0x52c8
    2d2f:	6a 01                	push   $0x1
    2d31:	e8 ea 0c 00 00       	call   3a20 <printf>
    exit();
    2d36:	e8 78 0b 00 00       	call   38b3 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d50:	ff 35 84 5e 00 00    	push   0x5e84
    2d56:	e8 c5 0c 00 00       	call   3a20 <printf>
  oldbrk = sbrk(0);
    2d5b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2d62:	e8 d4 0b 00 00       	call   393b <sbrk>
  a = sbrk(0);
    2d67:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2d6e:	89 45 a4             	mov    %eax,-0x5c(%ebp)
  a = sbrk(0);
    2d71:	e8 c5 0b 00 00       	call   393b <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 af 0b 00 00       	call   393b <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 fe 0a 00 00       	call   38ab <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 77 0b 00 00       	call   393b <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 6b 0b 00 00       	call   393b <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 d3 0a 00 00       	call   38bb <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 49 0b 00 00       	call   393b <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 38 0b 00 00       	call   393b <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e18:	6a 00                	push   $0x0
    2e1a:	e8 1c 0b 00 00       	call   393b <sbrk>
  c = sbrk(-4096);
    2e1f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e26:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e28:	e8 0e 0b 00 00       	call   393b <sbrk>
  ...
  c = sbrk(0);
    ...
    2e3c:	6a 00                	push   $0x0
    2e3e:	e8 f8 0a 00 00       	call   393b <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e57:	6a 00                	push   $0x0
    2e59:	e8 dd 0a 00 00       	call   393b <sbrk>
  c = sbrk(4096);
    2e5e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e65:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e67:	e8 cf 0a 00 00       	call   393b <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e7c:	6a 00                	push   $0x0
    2e7e:	e8 b8 0a 00 00       	call   393b <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2edf:	90                   	nop
    ppid = getpid();
    2ee0:	e8 4e 0a 00 00       	call   3933 <getpid>
    2ee5:	89 c6                	mov    %eax,%esi
    pid = fork();
    2ee7:	e8 bf 09 00 00       	call   38ab <fork>
    if(pid < 0){
    ...
    wait();
    2efa:	e8 bc 09 00 00       	call   38bb <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f13:	50                   	push   %eax
    2f14:	e8 aa 09 00 00       	call   38c3 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f30:	e8 76 09 00 00       	call   38ab <fork>
    ...
    2f50:	e8 76 09 00 00       	call   38cb <read>
  ...
  c = sbrk(4096);
    ...
    2f67:	e8 cf 09 00 00       	call   393b <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f82:	50                   	push   %eax
    2f83:	e8 5b 09 00 00       	call   38e3 <kill>
    wait();
    2f88:	e8 2e 09 00 00       	call   38bb <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fa3:	6a 00                	push   $0x0
    2fa5:	e8 91 09 00 00       	call   393b <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fba:	ff 35 84 5e 00 00    	push   0x5e84
    2fc0:	e8 5b 0a 00 00       	call   3a20 <printf>
}
    ...
    303e:	ff 35 84 5e 00 00    	push   0x5e84
    3044:	e8 d7 09 00 00       	call   3a20 <printf>
      exit();
    3049:	83 c4 20             	add    $0x20,%esp
    304c:	e8 62 08 00 00       	call   38b3 <exit>
      printf(stdout, "fork failed\n");
    3051:	83 ec 08             	sub    $0x8,%esp
    3054:	68 b9 4c 00 00       	push   $0x4cb9
    3059:	ff 35 84 5e 00 00    	push   0x5e84
    305f:	e8 bc 09 00 00       	call   3a20 <printf>
      exit();
    3064:	e8 4a 08 00 00       	call   38b3 <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    3069:	0f be 03             	movsbl (%ebx),%eax
    306c:	50                   	push   %eax
    306d:	53                   	push   %ebx
    306e:	68 dc 4b 00 00       	push   $0x4bdc
    3073:	ff 35 84 5e 00 00    	push   0x5e84
    3079:	e8 a2 09 00 00       	call   3a20 <printf>
      kill(ppid);
    307e:	89 34 24             	mov    %esi,(%esp)
    3081:	e8 5d 08 00 00       	call   38e3 <kill>
      exit();
    3086:	e8 28 08 00 00       	call   38b3 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    308b:	50                   	push   %eax
    308c:	53                   	push   %ebx
    308d:	68 bc 53 00 00       	push   $0x53bc
    3092:	ff 35 84 5e 00 00    	push   0x5e84
    3098:	e8 83 09 00 00       	call   3a20 <printf>
    exit();
    309d:	e8 11 08 00 00       	call   38b3 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    30a2:	56                   	push   %esi
    30a3:	56                   	push   %esi
    30a4:	68 ec 52 00 00       	push   $0x52ec
    30a9:	ff 35 84 5e 00 00    	push   0x5e84
    30af:	e8 6c 09 00 00       	call   3a20 <printf>
    exit();
    30b4:	e8 fa 07 00 00       	call   38b3 <exit>
    printf(stdout, "sbrk test fork failed\n");
    30b9:	50                   	push   %eax
    30ba:	50                   	push   %eax
    30bb:	68 8e 4b 00 00       	push   $0x4b8e
    30c0:	ff 35 84 5e 00 00    	push   0x5e84
    30c6:	e8 55 09 00 00       	call   3a20 <printf>
    exit();
    30cb:	e8 e3 07 00 00       	call   38b3 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    30d0:	51                   	push   %ecx
    30d1:	51                   	push   %ecx
    30d2:	68 8c 53 00 00       	push   $0x538c
    30d7:	ff 35 84 5e 00 00    	push   0x5e84
    30dd:	e8 3e 09 00 00       	call   3a20 <printf>
    exit();
    30e2:	e8 cc 07 00 00       	call   38b3 <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30e7:	50                   	push   %eax
    30e8:	50                   	push   %eax
    30e9:	68 f5 4b 00 00       	push   $0x4bf5
    30ee:	ff 35 84 5e 00 00    	push   0x5e84
    30f4:	e8 27 09 00 00       	call   3a20 <printf>
    exit();
    30f9:	e8 b5 07 00 00       	call   38b3 <exit>
    printf(1, "pipe() failed\n");
    30fe:	52                   	push   %edx
    30ff:	52                   	push   %edx
    3100:	68 b1 40 00 00       	push   $0x40b1
    3105:	6a 01                	push   $0x1
    3107:	e8 14 09 00 00       	call   3a20 <printf>
    exit();
    310c:	e8 a2 07 00 00       	call   38b3 <exit>
    exit();
    3111:	e8 9d 07 00 00       	call   38b3 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 a5 4b 00 00       	push   $0x4ba5
    311d:	ff 35 84 5e 00 00    	push   0x5e84
    3123:	e8 f8 08 00 00       	call   3a20 <printf>
    exit();
    3128:	e8 86 07 00 00       	call   38b3 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 64 53 00 00       	push   $0x5364
    3134:	ff 35 84 5e 00 00    	push   0x5e84
    313a:	e8 e1 08 00 00       	call   3a20 <printf>
    exit();
    313f:	e8 6f 07 00 00       	call   38b3 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 2c 53 00 00       	push   $0x532c
    314b:	ff 35 84 5e 00 00    	push   0x5e84
    3151:	e8 ca 08 00 00       	call   3a20 <printf>
    exit();
    3156:	e8 58 07 00 00       	call   38b3 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 c1 4b 00 00       	push   $0x4bc1
    3162:	ff 35 84 5e 00 00    	push   0x5e84
    3168:	e8 b3 08 00 00       	call   3a20 <printf>
    exit();
    316d:	e8 41 07 00 00       	call   38b3 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319f:	ff 35 84 5e 00 00    	push   0x5e84
    31a5:	e8 76 08 00 00       	call   3a20 <printf>
    31aa:	83 c4 10             	add    $0x10,%esp
    31ad:	8d 76 00             	lea    0x0(%esi),%esi
    if((pid = fork()) == 0){
    31b0:	e8 f6 06 00 00       	call   38ab <fork>
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 7e 07 00 00       	call   3943 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 72 07 00 00       	call   3943 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 0a 07 00 00       	call   38e3 <kill>
    wait();
    31d9:	e8 dd 06 00 00       	call   38bb <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 2d 4c 00 00       	push   $0x4c2d
    31e6:	e8 28 07 00 00       	call   3913 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 84 5e 00 00    	push   0x5e84
    320f:	e8 0c 08 00 00       	call   3a20 <printf>
}
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 90 06 00 00       	call   38b3 <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 38 4c 00 00       	push   $0x4c38
    322b:	ff 35 84 5e 00 00    	push   0x5e84
    3231:	e8 ea 07 00 00       	call   3a20 <printf>
      exit();
    3236:	e8 78 06 00 00       	call   38b3 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 84 5e 00 00    	push   0x5e84
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 84 5e 00 00    	push   0x5e84
    3281:	e8 9a 07 00 00       	call   3a20 <printf>
}
    ...
    3293:	ff 35 84 5e 00 00    	push   0x5e84
    3299:	e8 82 07 00 00       	call   3a20 <printf>
      exit();
    329e:	e8 10 06 00 00       	call   38b3 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 43 06 00 00       	call   3903 <unlink>
  pid = fork();
    32c0:	e8 e6 05 00 00       	call   38ab <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 e4 05 00 00       	call   38bb <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 86 4c 00 00       	push   $0x4c86
    32e1:	e8 0d 06 00 00       	call   38f3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 e1 05 00 00       	call   38db <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 86 4c 00 00 	movl   $0x4c86,(%esp)
    3301:	e8 fd 05 00 00       	call   3903 <unlink>
}
    ...
    3310:	c7 04 85 c0 a5 00 00 	movl   $0x53e0,0xa5c0(,%eax,4)
    3317:	e0 53 00 00 
    ...
    332a:	ff 35 84 5e 00 00    	push   0x5e84
    args[MAXARG-1] = 0;
    ...
    334b:	e8 9b 05 00 00       	call   38eb <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 9d 4c 00 00       	push   $0x4c9d
    3357:	ff 35 84 5e 00 00    	push   0x5e84
    335d:	e8 be 06 00 00       	call   3a20 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3362:	58                   	pop    %eax
    3363:	5a                   	pop    %edx
    3364:	68 00 02 00 00       	push   $0x200
    3369:	68 86 4c 00 00       	push   $0x4c86
    336e:	e8 80 05 00 00       	call   38f3 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 60 05 00 00       	call   38db <close>
    exit();
    337b:	e8 33 05 00 00       	call   38b3 <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 c6 4c 00 00       	push   $0x4cc6
    3387:	ff 35 84 5e 00 00    	push   0x5e84
    338d:	e8 8e 06 00 00       	call   3a20 <printf>
    exit();
    3392:	e8 1c 05 00 00       	call   38b3 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 ad 4c 00 00       	push   $0x4cad
    339e:	ff 35 84 5e 00 00    	push   0x5e84
    33a4:	e8 77 06 00 00       	call   3a20 <printf>
    exit();
    33a9:	e8 05 05 00 00       	call   38b3 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    33c0:	6a 01                	push   $0x1
    33c2:	e8 59 06 00 00       	call   3a20 <printf>
    ...
    3447:	6a 01                	push   $0x1
    3449:	e8 d2 05 00 00       	call   3a20 <printf>
    ...
    3458:	50                   	push   %eax
    3459:	e8 95 04 00 00       	call   38f3 <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 4e 04 00 00       	call   38d3 <write>
      if(cc < 512)
    ...
    3498:	6a 01                	push   $0x1
    349a:	e8 81 05 00 00       	call   3a20 <printf>
    close(fd);
    349f:	89 3c 24             	mov    %edi,(%esp)
    34a2:	e8 34 04 00 00       	call   38db <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34c2:	6a 01                	push   $0x1
    34c4:	e8 57 05 00 00       	call   3a20 <printf>
      break;
    ...
    354b:	50                   	push   %eax
    354c:	e8 b2 03 00 00       	call   3903 <unlink>
  while(nfiles >= 0){
  ...
  printf(1, "fsfull test finished\n");
    ...
    3561:	6a 01                	push   $0x1
    3563:	e8 b8 04 00 00       	call   3a20 <printf>
}
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 14 03 00 00       	call   38ab <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 16 03 00 00       	call   38bb <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 d6 02 00 00       	call   38b3 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 c3 02 00 00       	call   38b3 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 f0 02 00 00       	call   38f3 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 25 03 00 00       	call   393b <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 a6 02 00 00       	call   38cb <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 ae 02 00 00       	call   38db <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3651:	e8 5d 02 00 00       	call   38b3 <exit>
    3656:	66 90                	xchg   %ax,%ax
    3658:	66 90                	xchg   %ax,%ax
    365a:	66 90                	xchg   %ax,%ax
    ...
    3661:	31 c0                	xor    %eax,%eax
{
    ...
    3665:	53                   	push   %ebx
    3666:	8b 4d 08             	mov    0x8(%ebp),%ecx
    3669:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    366c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while((*s++ = *t++) != 0)
    3670:	0f b6 14 03          	movzbl (%ebx,%eax,1),%edx
    3674:	88 14 01             	mov    %dl,(%ecx,%eax,1)
    3677:	83 c0 01             	add    $0x1,%eax
    367a:	84 d2                	test   %dl,%dl
    367c:	75 f2                	jne    3670 <strcpy+0x10>
    ;
  return os;
}
    367e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3681:	89 c8                	mov    %ecx,%eax
    3683:	c9                   	leave  
    3684:	c3                   	ret    
    3685:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q)
    ...
    369f:	75 17                	jne    36b8 <strcmp+0x28>
    36a1:	eb 3a                	jmp    36dd <strcmp+0x4d>
    36a3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    36a7:	90                   	nop
    36a8:	0f b6 42 01          	movzbl 0x1(%edx),%eax
    p++, q++;
    36ac:	83 c2 01             	add    $0x1,%edx
    36af:	8d 59 01             	lea    0x1(%ecx),%ebx
  while(*p && *p == *q)
    36b2:	84 c0                	test   %al,%al
    36b4:	74 1a                	je     36d0 <strcmp+0x40>
    p++, q++;
    36b6:	89 d9                	mov    %ebx,%ecx
  while(*p && *p == *q)
    36b8:	0f b6 19             	movzbl (%ecx),%ebx
    36bb:	38 c3                	cmp    %al,%bl
    36bd:	74 e9                	je     36a8 <strcmp+0x18>
  return (uchar)*p - (uchar)*q;
    36bf:	29 d8                	sub    %ebx,%eax
}
    36c1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
    36c6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    36cd:	8d 76 00             	lea    0x0(%esi),%esi
  return (uchar)*p - (uchar)*q;
    36d0:	0f b6 59 01          	movzbl 0x1(%ecx),%ebx
    36d4:	31 c0                	xor    %eax,%eax
    36d6:	29 d8                	sub    %ebx,%eax
}
    36d8:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    36db:	c9                   	leave  
    36dc:	c3                   	ret    
  return (uchar)*p - (uchar)*q;
    36dd:	0f b6 19             	movzbl (%ecx),%ebx
    36e0:	31 c0                	xor    %eax,%eax
    36e2:	eb db                	jmp    36bf <strcmp+0x2f>
    36e4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
strlen(const char *s)
{
    ...
    36f3:	8b 55 08             	mov    0x8(%ebp),%edx
  int n;

  for(n = 0; s[n]; n++)
    36f6:	80 3a 00             	cmpb   $0x0,(%edx)
    36f9:	74 15                	je     3710 <strlen+0x20>
    36fb:	31 c0                	xor    %eax,%eax
    36fd:	8d 76 00             	lea    0x0(%esi),%esi
    3700:	83 c0 01             	add    $0x1,%eax
    3703:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
    3707:	89 c1                	mov    %eax,%ecx
    3709:	75 f5                	jne    3700 <strlen+0x10>
    ;
  return n;
}
    370b:	89 c8                	mov    %ecx,%eax
    370d:	5d                   	pop    %ebp
    370e:	c3                   	ret    
    370f:	90                   	nop
  for(n = 0; s[n]; n++)
    3710:	31 c9                	xor    %ecx,%ecx
}
    3712:	5d                   	pop    %ebp
    3713:	89 c8                	mov    %ecx,%eax
    3715:	c3                   	ret    
...
strchr(const char *s, char c)
{
    ...
    3746:	0f b6 4d 0c          	movzbl 0xc(%ebp),%ecx
  for(; *s; s++)
    374a:	0f b6 10             	movzbl (%eax),%edx
    374d:	84 d2                	test   %dl,%dl
    374f:	75 12                	jne    3763 <strchr+0x23>
    3751:	eb 1d                	jmp    3770 <strchr+0x30>
    3753:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3757:	90                   	nop
    3758:	0f b6 50 01          	movzbl 0x1(%eax),%edx
    375c:	83 c0 01             	add    $0x1,%eax
    375f:	84 d2                	test   %dl,%dl
    3761:	74 0d                	je     3770 <strchr+0x30>
    if(*s == c)
    3763:	38 d1                	cmp    %dl,%cl
    3765:	75 f1                	jne    3758 <strchr+0x18>
      return (char*)s;
  return 0;
}
    3767:	5d                   	pop    %ebp
  ...
  return 0;
    ...
    3772:	5d                   	pop    %ebp
    3773:	c3                   	ret    
    3774:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    377b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    377f:	90                   	nop
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    cc = read(0, &c, 1);
    3785:	8d 7d e7             	lea    -0x19(%ebp),%edi
{
    3788:	53                   	push   %ebx
  for(i=0; i+1 < max; ){
    3789:	31 db                	xor    %ebx,%ebx
{
    378b:	83 ec 1c             	sub    $0x1c,%esp
  for(i=0; i+1 < max; ){
    378e:	eb 27                	jmp    37b7 <gets+0x37>
    cc = read(0, &c, 1);
    3790:	83 ec 04             	sub    $0x4,%esp
    3793:	6a 01                	push   $0x1
    3795:	57                   	push   %edi
    3796:	6a 00                	push   $0x0
    3798:	e8 2e 01 00 00       	call   38cb <read>
    if(cc < 1)
    379d:	83 c4 10             	add    $0x10,%esp
    37a0:	85 c0                	test   %eax,%eax
    37a2:	7e 1d                	jle    37c1 <gets+0x41>
      break;
    buf[i++] = c;
    37a4:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
    37a8:	8b 55 08             	mov    0x8(%ebp),%edx
    37ab:	88 44 1a ff          	mov    %al,-0x1(%edx,%ebx,1)
    if(c == '\n' || c == '\r')
    37af:	3c 0a                	cmp    $0xa,%al
    37b1:	74 1d                	je     37d0 <gets+0x50>
    37b3:	3c 0d                	cmp    $0xd,%al
    37b5:	74 19                	je     37d0 <gets+0x50>
  for(i=0; i+1 < max; ){
    37b7:	89 de                	mov    %ebx,%esi
    37b9:	83 c3 01             	add    $0x1,%ebx
    37bc:	3b 5d 0c             	cmp    0xc(%ebp),%ebx
    37bf:	7c cf                	jl     3790 <gets+0x10>
      break;
  }
  buf[i] = '\0';
    37c1:	8b 45 08             	mov    0x8(%ebp),%eax
    37c4:	c6 04 30 00          	movb   $0x0,(%eax,%esi,1)
  return buf;
}
    37c8:	8d 65 f4             	lea    -0xc(%ebp),%esp
    37cb:	5b                   	pop    %ebx
    37cc:	5e                   	pop    %esi
    37cd:	5f                   	pop    %edi
    37ce:	5d                   	pop    %ebp
  ...
  buf[i] = '\0';
    ...
    37d3:	89 de                	mov    %ebx,%esi
    37d5:	c6 04 30 00          	movb   $0x0,(%eax,%esi,1)
}
    37d9:	8d 65 f4             	lea    -0xc(%ebp),%esp
    37dc:	5b                   	pop    %ebx
    37dd:	5e                   	pop    %esi
    37de:	5f                   	pop    %edi
    37df:	5d                   	pop    %ebp
    ...
    37e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    37ef:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3979:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
  uint x;
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
    397c:	89 d1                	mov    %edx,%ecx
{
    397e:	89 45 b8             	mov    %eax,-0x48(%ebp)
  if(sgn && xx < 0){
    3981:	85 d2                	test   %edx,%edx
    3983:	0f 89 7f 00 00 00    	jns    3a08 <printint+0x98>
    3989:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    398d:	74 79                	je     3a08 <printint+0x98>
    neg = 1;
    398f:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    x = -xx;
    3996:	f7 d9                	neg    %ecx
  } else {
    x = xx;
  ...
  i = 0;
    3998:	31 db                	xor    %ebx,%ebx
    399a:	8d 75 d7             	lea    -0x29(%ebp),%esi
  ...
  do{
    ...
    39a6:	f7 75 c4             	divl   -0x3c(%ebp)
    39a9:	0f b6 92 70 55 00 00 	movzbl 0x5570(%edx),%edx
    39b0:	89 45 c0             	mov    %eax,-0x40(%ebp)
    39b3:	89 d8                	mov    %ebx,%eax
    39b5:	8d 5b 01             	lea    0x1(%ebx),%ebx
  }while((x /= base) != 0);
    39b8:	8b 4d c0             	mov    -0x40(%ebp),%ecx
    buf[i++] = digits[x % base];
    39bb:	88 14 1e             	mov    %dl,(%esi,%ebx,1)
  }while((x /= base) != 0);
    39be:	39 7d c4             	cmp    %edi,-0x3c(%ebp)
    39c1:	76 dd                	jbe    39a0 <printint+0x30>
  if(neg)
    39c3:	8b 4d bc             	mov    -0x44(%ebp),%ecx
    39c6:	85 c9                	test   %ecx,%ecx
    39c8:	74 0c                	je     39d6 <printint+0x66>
    buf[i++] = '-';
    39ca:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    buf[i++] = digits[x % base];
    39cf:	89 d8                	mov    %ebx,%eax
    buf[i++] = '-';
    39d1:	ba 2d 00 00 00       	mov    $0x2d,%edx

  while(--i >= 0)
    39d6:	8b 7d b8             	mov    -0x48(%ebp),%edi
    39d9:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
    39dd:	eb 07                	jmp    39e6 <printint+0x76>
    39df:	90                   	nop
    putc(fd, buf[i]);
    39e0:	0f b6 13             	movzbl (%ebx),%edx
    39e3:	83 eb 01             	sub    $0x1,%ebx
  write(fd, &c, 1);
    39e6:	83 ec 04             	sub    $0x4,%esp
    39e9:	88 55 d7             	mov    %dl,-0x29(%ebp)
    39ec:	6a 01                	push   $0x1
    39ee:	56                   	push   %esi
    39ef:	57                   	push   %edi
    39f0:	e8 de fe ff ff       	call   38d3 <write>
  while(--i >= 0)
    39f5:	83 c4 10             	add    $0x10,%esp
    39f8:	39 de                	cmp    %ebx,%esi
    39fa:	75 e4                	jne    39e0 <printint+0x70>
}
  ...
  neg = 0;
    3a08:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
    3a0f:	eb 87                	jmp    3998 <printint+0x28>
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3a29:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
    3a2c:	8b 75 08             	mov    0x8(%ebp),%esi
  for(i = 0; fmt[i]; i++){
    3a2f:	0f b6 13             	movzbl (%ebx),%edx
    3a32:	84 d2                	test   %dl,%dl
    3a34:	74 6a                	je     3aa0 <printf+0x80>
  ap = (uint*)(void*)&fmt + 1;
    3a36:	8d 45 10             	lea    0x10(%ebp),%eax
    3a39:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    3a3c:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    3a3f:	31 c9                	xor    %ecx,%ecx
  ap = (uint*)(void*)&fmt + 1;
    3a41:	89 45 d0             	mov    %eax,-0x30(%ebp)
    3a44:	eb 36                	jmp    3a7c <printf+0x5c>
    3a46:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3a4d:	8d 76 00             	lea    0x0(%esi),%esi
    3a50:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    3a53:	b9 25 00 00 00       	mov    $0x25,%ecx
      if(c == '%'){
    3a58:	83 f8 25             	cmp    $0x25,%eax
    3a5b:	74 15                	je     3a72 <printf+0x52>
  write(fd, &c, 1);
    3a5d:	83 ec 04             	sub    $0x4,%esp
    3a60:	88 55 e7             	mov    %dl,-0x19(%ebp)
    3a63:	6a 01                	push   $0x1
    3a65:	57                   	push   %edi
    3a66:	56                   	push   %esi
    3a67:	e8 67 fe ff ff       	call   38d3 <write>
    3a6c:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
      } else {
        putc(fd, c);
    3a6f:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    3a72:	0f b6 13             	movzbl (%ebx),%edx
    3a75:	83 c3 01             	add    $0x1,%ebx
    3a78:	84 d2                	test   %dl,%dl
    3a7a:	74 24                	je     3aa0 <printf+0x80>
    c = fmt[i] & 0xff;
    3a7c:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    3a7f:	85 c9                	test   %ecx,%ecx
    3a81:	74 cd                	je     3a50 <printf+0x30>
      }
    } else if(state == '%'){
    3a83:	83 f9 25             	cmp    $0x25,%ecx
    3a86:	75 ea                	jne    3a72 <printf+0x52>
      if(c == 'd' || c == 'u'){
    3a88:	83 f8 25             	cmp    $0x25,%eax
    3a8b:	0f 84 ff 00 00 00    	je     3b90 <printf+0x170>
    3a91:	83 e8 63             	sub    $0x63,%eax
    3a94:	83 f8 15             	cmp    $0x15,%eax
    3a97:	77 17                	ja     3ab0 <printf+0x90>
    3a99:	ff 24 85 18 55 00 00 	jmp    *0x5518(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    3ab3:	88 55 d4             	mov    %dl,-0x2c(%ebp)
    3ab6:	6a 01                	push   $0x1
    3ab8:	57                   	push   %edi
    3ab9:	56                   	push   %esi
    3aba:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3abe:	e8 10 fe ff ff       	call   38d3 <write>
        putc(fd, c);
    3ac3:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
  write(fd, &c, 1);
    3ac7:	83 c4 0c             	add    $0xc,%esp
    3aca:	88 55 e7             	mov    %dl,-0x19(%ebp)
    3acd:	6a 01                	push   $0x1
    3acf:	57                   	push   %edi
    3ad0:	56                   	push   %esi
    ...
    3ad6:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3ad9:	31 c9                	xor    %ecx,%ecx
    3adb:	eb 95                	jmp    3a72 <printf+0x52>
    3add:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    3ae0:	83 ec 0c             	sub    $0xc,%esp
    3ae3:	b9 10 00 00 00       	mov    $0x10,%ecx
    3ae8:	6a 00                	push   $0x0
    3aea:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3aed:	8b 10                	mov    (%eax),%edx
    3aef:	89 f0                	mov    %esi,%eax
    3af1:	e8 7a fe ff ff       	call   3970 <printint>
        ap++;
    3af6:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    3afa:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3afd:	31 c9                	xor    %ecx,%ecx
    3aff:	e9 6e ff ff ff       	jmp    3a72 <printf+0x52>
    3b04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        printint(fd, *ap, 10, 1);
    3b08:	83 ec 0c             	sub    $0xc,%esp
    3b0b:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3b10:	6a 01                	push   $0x1
    3b12:	eb d6                	jmp    3aea <printf+0xca>
  ...
  write(fd, &c, 1);
    ...
    3b23:	56                   	push   %esi
        putc(fd, *ap);
    3b24:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3b27:	e8 a7 fd ff ff       	call   38d3 <write>
        ap++;
    3b2c:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    3b30:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3b33:	31 c9                	xor    %ecx,%ecx
    3b35:	e9 38 ff ff ff       	jmp    3a72 <printf+0x52>
    3b3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        s = (char*)*ap;
    3b40:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3b43:	8b 10                	mov    (%eax),%edx
        ap++;
    3b45:	83 c0 04             	add    $0x4,%eax
    3b48:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    3b4b:	85 d2                	test   %edx,%edx
    3b4d:	74 51                	je     3ba0 <printf+0x180>
        while(*s != 0){
    3b4f:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
    3b52:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
    3b54:	84 c0                	test   %al,%al
    3b56:	0f 84 16 ff ff ff    	je     3a72 <printf+0x52>
    3b5c:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    3b5f:	89 d3                	mov    %edx,%ebx
    3b61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    3b68:	83 ec 04             	sub    $0x4,%esp
          s++;
    3b6b:	83 c3 01             	add    $0x1,%ebx
    3b6e:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3b71:	6a 01                	push   $0x1
    3b73:	57                   	push   %edi
    3b74:	56                   	push   %esi
    3b75:	e8 59 fd ff ff       	call   38d3 <write>
        while(*s != 0){
    3b7a:	0f b6 03             	movzbl (%ebx),%eax
    3b7d:	83 c4 10             	add    $0x10,%esp
    3b80:	84 c0                	test   %al,%al
    3b82:	75 e4                	jne    3b68 <printf+0x148>
      state = 0;
    3b84:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    3b87:	31 c9                	xor    %ecx,%ecx
    3b89:	e9 e4 fe ff ff       	jmp    3a72 <printf+0x52>
    3b8e:	66 90                	xchg   %ax,%ax
        putc(fd, c);
    3b90:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    3b93:	83 ec 04             	sub    $0x4,%esp
    3b96:	e9 32 ff ff ff       	jmp    3acd <printf+0xad>
    3b9b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3b9f:	90                   	nop
          s = "(null)";
    3ba0:	ba 0e 55 00 00       	mov    $0x550e,%edx
        while(*s != 0){
    3ba5:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    3ba8:	b8 28 00 00 00       	mov    $0x28,%eax
    3bad:	89 d3                	mov    %edx,%ebx
    3baf:	eb b7                	jmp    3b68 <printf+0x148>
    3bb1:	66 90                	xchg   %ax,%ax
    3bb3:	66 90                	xchg   %ax,%ax
    3bb5:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3bc1:	a1 40 a6 00 00       	mov    0xa640,%eax
{
  ...
  freep = p;
    ...
    3c01:	5b                   	pop    %ebx
  freep = p;
    3c02:	89 15 40 a6 00 00    	mov    %edx,0xa640
}
    3c08:	5e                   	pop    %esi
    3c09:	5f                   	pop    %edi
    3c0a:	5d                   	pop    %ebp
  ...
  freep = p;
    3c3c:	89 15 40 a6 00 00    	mov    %edx,0xa640
    p->s.size += bp->s.size;
    3c42:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    3c45:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    3c48:	89 0a                	mov    %ecx,(%edx)
}
    3c4a:	5b                   	pop    %ebx
    3c4b:	5e                   	pop    %esi
    3c4c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c5c:	8b 3d 40 a6 00 00    	mov    0xa640,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3c73:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    3c75:	8b 4a 04             	mov    0x4(%edx),%ecx
    3c78:	39 f1                	cmp    %esi,%ecx
    3c7a:	73 6a                	jae    3ce6 <malloc+0x96>
    3c7c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3c81:	39 de                	cmp    %ebx,%esi
    3c83:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    3c86:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3c8d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    3c90:	eb 17                	jmp    3ca9 <malloc+0x59>
    3c92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3c98:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3c9a:	8b 48 04             	mov    0x4(%eax),%ecx
    3c9d:	39 f1                	cmp    %esi,%ecx
    3c9f:	73 4f                	jae    3cf0 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    3ca1:	8b 3d 40 a6 00 00    	mov    0xa640,%edi
    3ca7:	89 c2                	mov    %eax,%edx
    3ca9:	39 d7                	cmp    %edx,%edi
    3cab:	75 eb                	jne    3c98 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    3cad:	83 ec 0c             	sub    $0xc,%esp
    3cb0:	ff 75 e4             	push   -0x1c(%ebp)
    3cb3:	e8 83 fc ff ff       	call   393b <sbrk>
  if(p == (char*)-1)
    3cb8:	83 c4 10             	add    $0x10,%esp
    3cbb:	83 f8 ff             	cmp    $0xffffffff,%eax
    3cbe:	74 1c                	je     3cdc <malloc+0x8c>
  hp->s.size = nu;
    3cc0:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3cc3:	83 ec 0c             	sub    $0xc,%esp
    3cc6:	83 c0 08             	add    $0x8,%eax
    3cc9:	50                   	push   %eax
    3cca:	e8 f1 fe ff ff       	call   3bc0 <free>
  return freep;
    3ccf:	8b 15 40 a6 00 00    	mov    0xa640,%edx
      if((p = morecore(nunits)) == 0)
    3cd5:	83 c4 10             	add    $0x10,%esp
    3cd8:	85 d2                	test   %edx,%edx
    3cda:	75 bc                	jne    3c98 <malloc+0x48>
        return 0;
  }
}
    3cdc:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    3ce8:	89 fa                	mov    %edi,%edx
    3cea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    3cf0:	39 ce                	cmp    %ecx,%esi
    3cf2:	74 4c                	je     3d40 <malloc+0xf0>
        p->s.size -= nunits;
    3cf4:	29 f1                	sub    %esi,%ecx
    3cf6:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    3cf9:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3cfc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3cff:	89 15 40 a6 00 00    	mov    %edx,0xa640
}
    ...
    3d0f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3d10:	c7 05 40 a6 00 00 44 	movl   $0xa644,0xa640
    3d17:	a6 00 00 
    base.s.size = 0;
    3d1a:	bf 44 a6 00 00       	mov    $0xa644,%edi
    base.s.ptr = freep = prevp = &base;
    3d1f:	c7 05 44 a6 00 00 44 	movl   $0xa644,0xa644
    3d26:	a6 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d29:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3d2b:	c7 05 48 a6 00 00 00 	movl   $0x0,0xa648
    3d32:	00 00 00 
    if(p->s.size >= nunits){
    3d35:	e9 42 ff ff ff       	jmp    3c7c <malloc+0x2c>
    3d3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    3d40:	8b 08                	mov    (%eax),%ecx
    3d42:	89 0a                	mov    %ecx,(%edx)
    3d44:	eb b9                	jmp    3cff <malloc+0xaf>
...
void srand(unsigned seed) {
    ...
    3d56:	5d                   	pop    %ebp
    next = seed;
    3d57:	a3 9c 5e 00 00       	mov    %eax,0x5e9c
}
    3d5c:	c3                   	ret    
...
int rand(void) {
    ...
    3d60:	69 05 9c 5e 00 00 6d 	imul   $0x41c64e6d,0x5e9c,%eax
    3d67:	4e c6 41 
    3d6a:	05 39 30 00 00       	add    $0x3039,%eax
    3d6f:	a3 9c 5e 00 00       	mov    %eax,0x5e9c
    return((unsigned)(next/65536) % RAND_MAX);
    3d74:	c1 e8 10             	shr    $0x10,%eax
}
    3d77:	c3                   	ret    
