   ...
   a:	8b 11                	mov    (%ecx),%edx
{
  ...
  16:	7f 05                	jg     1d <main+0x1d>
	...
	exit();
  18:	e8 96 02 00 00       	call   2b3 <exit>
		srand((*argv[1]));
  1d:	8b 40 04             	mov    0x4(%eax),%eax
  20:	83 ec 0c             	sub    $0xc,%esp
  23:	bb 0a 00 00 00       	mov    $0xa,%ebx
  28:	0f be 00             	movsbl (%eax),%eax
  2b:	50                   	push   %eax
  2c:	e8 1f 07 00 00       	call   750 <srand>
  31:	83 c4 10             	add    $0x10,%esp
  34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
			printf(1, "random number is: %d\n",rand());
  38:	e8 23 07 00 00       	call   760 <rand>
  3d:	83 ec 04             	sub    $0x4,%esp
  40:	50                   	push   %eax
  41:	68 78 07 00 00       	push   $0x778
  46:	6a 01                	push   $0x1
  48:	e8 d3 03 00 00       	call   420 <printf>
		for(int i=0;i<10;i++){
  4d:	83 c4 10             	add    $0x10,%esp
  50:	83 eb 01             	sub    $0x1,%ebx
  53:	75 e3                	jne    38 <main+0x38>
  55:	eb c1                	jmp    18 <main+0x18>
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
  5b:	66 90                	xchg   %ax,%ax
  5d:	66 90                	xchg   %ax,%ax
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 59f:	90                   	nop
          s = "(null)";
 5a0:	ba 8e 07 00 00       	mov    $0x78e,%edx
        while(*s != 0){
 ...
 5c1:	a1 d4 0a 00 00       	mov    0xad4,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 d4 0a 00 00    	mov    %edx,0xad4
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 d4 0a 00 00    	mov    %edx,0xad4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d d4 0a 00 00    	mov    0xad4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d d4 0a 00 00    	mov    0xad4,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 d4 0a 00 00    	mov    0xad4,%edx
 ...
 6fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 d4 0a 00 00    	mov    %edx,0xad4
}
 ...
 70f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 d4 0a 00 00 d8 	movl   $0xad8,0xad4
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf d8 0a 00 00       	mov    $0xad8,%edi
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 d8 0a 00 00 d8 	movl   $0xad8,0xad8
 726:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 dc 0a 00 00 00 	movl   $0x0,0xadc
 732:	00 00 00 
    if(p->s.size >= nunits){
...
void srand(unsigned seed) {
 ...
 756:	5d                   	pop    %ebp
    next = seed;
 757:	a3 d0 0a 00 00       	mov    %eax,0xad0
}
 75c:	c3                   	ret    
...
int rand(void) {
 ...
 760:	69 05 d0 0a 00 00 6d 	imul   $0x41c64e6d,0xad0,%eax
 767:	4e c6 41 
 76a:	05 39 30 00 00       	add    $0x3039,%eax
 76f:	a3 d0 0a 00 00       	mov    %eax,0xad0
